...
##       (cur_tableau_add_mesh, ":banner_mesh", pos1, ":banner_scale", 0),
  ...
  ("faction_note_mesh_banner", 0, "tableau_with_transparency", 1024, 1024, 0, 0, 200, 200,
   [
     ...
     (else_try),
       (troop_get_slot, ":banner_mesh", ":leader_troop", slot_troop_custom_banner_flag_type),
       (init_position, pos1),
       (position_set_y, pos1, 100),
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 210, 210, 0, 100000),
...
# DUNDE's BEGIN
  ("custom_banner_square_no_mesh", 0, "heraldic_armor_bg", 512, 512, 0, 0, 300, 300,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     #(try_begin),
     ...
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", 0, 0, 5000, 5000, 5000, 5000, 7000, 10000, 0),
     #(try_end),
     (cur_tableau_set_camera_parameters, 0, 100, 100, 0, 100000),
     ]),

  #("custom_banner_default", 0, "heraldic_armor_bg", 512, 256, 0, 0, 0, 0,
  ("custom_banner_default", 0, "heraldic_armor_bg_tall", 256, 512, 0, 0, 0, 0,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     #(try_begin),
     ...
     #     (call_script, "script_draw_banner_to_region", ":troop_no", "$debug1", "$debug2", "$debug3", "$debug4", "$debug5", "$debug6", "$debug7", "$debug8", "$debug9"), 
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", -8, 0, 3750, 4970, 5000, 5000, 7000, 10000, 0),
     #(try_end),
     (init_position, pos1),
     (position_set_z, pos1, 10),
  ...
  #("custom_banner_square", 0, "heraldic_armor_bg", 256, 256, 0, 0, 0, 0,
  ("custom_banner_square", 0, "heraldic_armor_bg", 256, 256, 0, 0, 0, 0,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     ...
     #     (call_script, "script_draw_banner_to_region", ":troop_no", "$debug1", "$debug2", "$debug3", "$debug4", "$debug5", "$debug6", "$debug7", "$debug8", "$debug9"), 
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", -10, 10, 5000, 5000, 5000, 5000, 7000, 10000, 0),
     #(try_end),
     (init_position, pos1),
     (position_set_z, pos1, 10),
  ...
  #("custom_banner_short", 0, "heraldic_armor_bg", 256, 512, 0, 0, 0, 0,
  ("custom_banner_short", 0, "heraldic_armor_bg_short", 256, 128, 0, 0, 0, 0,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     #(try_begin),
     ...
     #     (call_script, "script_draw_banner_to_region", ":troop_no", "$debug1", "$debug2", "$debug3", "$debug4", "$debug5", "$debug6", "$debug7", "$debug8", "$debug9"), 
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", -11, 0, 3800, 4970, 5000, 5000, 7000, 10000, 0),
     #(try_end),
     (init_position, pos1),
     (position_set_z, pos1, 10),
     (cur_tableau_add_mesh, "mesh_tableau_mesh_custom_banner", pos1, 0, 0),
  ...
  #("custom_banner_tall", 0, "heraldic_armor_bg", 512, 256, 0, 0, 0, 0,
  ("custom_banner_tall", 0, "heraldic_armor_bg_tall", 256, 512, 0, 0, 0, 0,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     #(try_begin),
     ...
     #     (call_script, "script_draw_banner_to_region", ":troop_no", "$debug1", "$debug2", "$debug3", "$debug4", "$debug5", "$debug6", "$debug7", "$debug8", "$debug9"), 
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", -9, 5, 4600, 4970, 5000, 5000, 10000, 10000, 0),
     #(try_end),
  ...
  #("custom_banner_flag", 0, "heraldic_armor_bg", 256, 512, 0, 0, 0, 0,
  ("custom_banner_flag", 0, "heraldic_armor_bg_short", 256, 128, 0, 0, 0, 0,
   [
     (store_script_param, ":troop_no", 1),
     (set_fixed_point_multiplier, 100),
     #(try_begin),
     ...
     #     (call_script, "script_draw_banner_to_region", ":troop_no", "$debug1", "$debug2", "$debug3", "$debug4", "$debug5", "$debug6", "$debug7", "$debug8", "$debug9"), 
     #  (else_try), 
     (call_script, "script_draw_banner_to_region", ":troop_no", -20, 0, 3000, 4970, 5000, 5000, 7000, 10000, 0),
     #(try_end),
     (init_position, pos1),
     (position_set_z, pos1, 10),
     (cur_tableau_add_mesh, "mesh_tableau_mesh_custom_banner", pos1, 0, 0),
