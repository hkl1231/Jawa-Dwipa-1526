...
pilgrim_disguise = [itm_civil_sunda_headband_01,itm_pandita_a,itm_practice_staff, itm_throwing_daggers, itm_invisifeet]
farmer_disguise = [itm_civil_sunda_caping_a, itm_civil_sunda_01, itm_sickle, itm_stones, itm_invisifeet]
hunter_disguise = [itm_hunting_bow,itm_barbed_arrows, itm_civil_sunda_headband_05, itm_civil_sunda_02, itm_sword_khergit_1, itm_invisifeet]
merchant_disguise = [itm_leather_jacket,itm_woolen_hose,itm_felt_steppe_cap,itm_dagger]
guard_disguise = [itm_hairband_universal_jawa_b,itm_demak_spearman_1, itm_feet, itm_jawa_pedang_a, itm_sunda_shield_a]
bard_disguise = [itm_civil_sunda_01, itm_sickle, itm_stones, itm_invisifeet]
...
enhanced_town_resident_behavior_init = (
  0, 0, ti_once, [], [
      ...
      (assign,"$in_conversation",0),

      (assign,"$accumulated_relation_deterioration_with_town_lord",0),
      (assign,"$accumulated_relation_deterioration_with_town",0),
      (assign,"$accumulated_relation_deterioration_with_faction",0),
      (assign,"$accumulated_bounty",0),
  ],[])
      ...
      (try_begin),
          ...
          (try_for_agents, ":cur_agent"),
              ...
              (else_try), 
                  ...
                  (lt,":dist",100),  
                  (call_script,"script_agent_make_hostile",":cur_agent"),
      ...
      (else_try),
          ...
          (try_begin),
              (try_for_agents, ":cur_agent"),
                  ...
                  (assign,":agent_to_look",-1),
                  (assign,":shortest_distance",750),
                  (agent_get_look_position,pos2,":cur_agent"),
                  (try_for_agents, ":other_agent"),
                      (neq,":cur_agent",":other_agent"),
                      (agent_get_look_position,pos4,":other_agent"),
                      (get_distance_between_positions,":distance", pos2, pos4),
                      (lt,":distance",":shortest_distance"),
                      (position_has_line_of_sight_to_position, pos2, pos4),
                      (assign,":agent_to_look",":other_agent"),
                      (assign,":shortest_distance",":distance"),
                  (try_end),
                  (ge,":agent_to_look",0),
                  (agent_get_look_position,pos4,":agent_to_look"),
                  (try_begin),
                      (position_is_behind_position,pos4,pos2),
                      #Do Nothing
                  (else_try),
                      (agent_set_look_target_agent, ":cur_agent", ":agent_to_look"),
                  (try_end),
              (try_end),
          (try_end),
          ...
          (try_for_agents, ":cur_agent"),
              ...
              (agent_set_team, ":cur_agent", 1),
              (display_message,"@You were condoned. But continued harassment will enrage the townsfolk."),
              (call_script,"script_character_add_bounty","trp_player",50),
              (val_add,"$accumulated_bounty",50),
              (call_script,"script_apply_relation_deteriorations"),
          (try_end),
      (else_try),
          (eq,"$town_residents_enraged",0),
          (this_or_next|gt,"$town_residents_condoned",1500),
          (ge,"$town_residents_condone_chance",2000),
          (call_script,"script_enrage_town"),
      (else_try),
          (eq,"$town_residents_enraged",0),
          (party_slot_eq,"$current_town",slot_center_alarmed_by_maniac,1),
          (try_for_agents, ":cur_agent"),
              (agent_is_human,":cur_agent"),
              (agent_is_alive,":cur_agent"),
              (neq,":cur_agent",":player_agent"),
              ...
              (try_begin),
                  ...
                  (try_end),
                  (eq,"$in_conversation",0),
                  (position_has_line_of_sight_to_position, pos2, pos3),
                  (lt,":distance",750),
                  (try_begin),
                      (troop_get_slot,":bounty","trp_player",slot_troop_bounty),
                      (ge,":bounty",2000),
                      (call_script,"script_agent_make_hostile",":cur_agent"),
                      (assign,"$town_residents_condoned",1500),
                      (assign,"$town_residents_condone_chance",1999),
                  (else_try),
                      (agent_clear_scripted_mode,":cur_agent"),
                      ...
                      (assign, "$talk_context", tc_town_alarmed_guard),
                      (assign, "$talk_agent", ":cur_agent"),
                      (assign,"$in_conversation",1),
                      (start_mission_conversation,":cur_agent_troop"),
                  (try_end),
              (try_end),
          (try_end),
      (else_try),
          ...
          (try_begin),
              (party_slot_eq,"$current_town",slot_center_alarmed_by_maniac,0),
              (party_set_slot,"$current_town",slot_center_alarmed_by_maniac, 1),
              (store_current_hours,":cur_time"),
              (party_set_slot,"$current_town",slot_center_alarmed_time, ":cur_time"),
              (party_get_slot,":count","$current_town",slot_center_times_attacked_in_past),
              (val_add,":count",1),
              (party_set_slot,"$current_town",slot_center_times_attacked_in_past, ":count"),
          (try_end),
          ...
          (try_for_agents, ":cur_agent"),
              ...
              (assign,":spawn_entry_no", -1),
              (try_begin),
                  (eq,":cur_scene",":town_scene"),
                  (assign,":spawn_entry_no", 2),
              (else_try),
                  (eq,":cur_scene",":tavern_scene"),
                  (assign,":spawn_entry_no", 0),     
              (try_end),
              (entry_point_get_position, pos3, ":spawn_entry_no"),
              (agent_set_scripted_destination_no_attack,":cur_agent",pos3,1),
              (agent_force_rethink,":cur_agent"),
              (agent_get_position,pos2,":cur_agent"),
              ...
              (try_begin),
                  ...
                  (try_begin),
                      ...
                      #(add_visitors_to_current_scene,":spawn_entry_no",":troop",1),
                      (spawn_agent,":troop"),
                      (call_script,"script_agent_make_hostile",reg0),
                      (assign,"$town_residents_condoned",0),
                      (display_message,"@Guard Reinforcements!"),
                  (try_end),
              (try_end),
          (try_end),
      (try_end),
...
enhanced_town_resident_behavior_hit = (
 ti_on_agent_hit, 0, 0, [], [
     ...
     (call_script,"script_agent_make_hostile",":hit_agent_no"),
     (val_add,"$town_residents_condone_chance",1000),
     (eq,"$town_residents_enraged",0),
     (display_message,"@You started a brawl! You can condone it by continuesly holding block."),
     ...
     (val_add,"$accumulated_relation_deterioration_with_town_lord",-1),
     (agent_get_troop_id,":player_troop", ":player_agent"),
     (call_script,"script_character_add_bounty",":player_troop",10),
     (val_add,"$accumulated_bounty",10),
 ],[])
...
[
   ...
   (try_begin), #-- Decapitations --#
	  ...
	  (try_begin), ### Special weapons that can decap, ovevrrides the below conditions
		  (this_or_next|eq, ":attacker_item", "itm_arena_spear"),
		  (eq, ":attacker_item", "itm_arena_spear"),
		  (assign, ":run", 1),
	  (else_try),
...
#-----------------------------------------------------------------
  ...
  (
    ...
    [(0,mtef_scene_source|mtef_team_0,af_override_horse,0,1,pilgrim_disguise),
     ...
     (9,mtef_visitor_source,0,0,1,[]),(10,mtef_visitor_source,0,0,1,[]),(11,mtef_visitor_source,0,0,1,[]),(12,mtef_visitor_source,0,0,1,[]),(13,mtef_visitor_source,0,0,1,[]),(14,mtef_scene_source,0,0,1,[]),(15,mtef_scene_source,0,0,1,[]),
     (16,mtef_visitor_source,0,0,1,[]),(17,mtef_visitor_source,0,0,1,[]),(18,mtef_visitor_source,0,0,1,[]),(19,mtef_visitor_source,0,0,1,[]),(20,mtef_visitor_source,0,0,1,[]),(21,mtef_visitor_source,0,0,1,[]),(22,mtef_visitor_source,0,0,1,[]),
	 ...
	 (36,mtef_visitor_source,0,0,1,[]), #town walker point
	 (37,mtef_visitor_source,0,0,1,[]), #town walker point
  ...
  (0, 0, ti_once, [],
    [
      ...
      (store_random_in_range, ":num_animals", 0, 4),
      (try_for_range, ":unused", 0, ":num_animals"),
        (gt, ":num_animals", 0),
        ...
        (assign, reg2, 0),
        (shuffle_range, 1, 3),
        (spawn_horse, "itm_dog_mount", reg1),
        (assign, ":agent", reg0),
        (agent_set_slot, ":agent", slot_agent_walker_occupation, 1),
        (store_random_in_range, ":rand", 32, 40),
        (entry_point_get_position, pos1, ":rand"),
      ...
      (try_for_range, ":unused", 0, ":num_animals"),
        ...
        (entry_point_get_position, pos1, ":rand"),
        (set_fixed_point_multiplier, 100),
        (position_move_y, pos1, 150),#avoiding hitting town walkers on spawn
        (set_spawn_position, pos1),
        (assign, reg1, 0),
        (assign, reg2, 0),
        (shuffle_range, 1, 3),
        (spawn_horse, "itm_cat_mount", reg1),
        (assign, ":agent", reg0),
        (agent_set_slot, ":agent", slot_agent_walker_occupation, 1),
        (store_random_in_range, ":rand", 32, 40),
        (entry_point_get_position, pos1, ":rand"),
      ...
      (try_for_range, ":unused", 0, ":num_animals"),
        ...
        (assign, reg2, 0),
        (shuffle_range, 1, 3),
        (spawn_horse, "itm_chicken_mount", reg1),
        (assign, ":agent", reg0),
        (agent_set_slot, ":agent", slot_agent_walker_occupation, 1),
        (store_random_in_range, ":rand", 32, 40),
        (entry_point_get_position, pos1, ":rand"),
  ...
  (3, 0, 0, [(neg|is_currently_night),],	#VC-2352 sound
    [
      ...
      (try_for_agents, ":agent"),
        ...
        (eq, ":item", "itm_chicken_mount"),
        (store_random_in_range, ":rand", 0, 3),
        (eq, ":rand", 0),
        (agent_play_sound, ":agent", "snd_chicken_cluck"),
  ...
  (3, 0, 0, [(neg|is_currently_night),],	#VC-2352 sound
    [
      ...
      (try_for_agents, ":agent"),
        ...
        (agent_is_alive, ":agent"),
        (agent_get_item_id, ":item", ":agent"),
        (eq, ":item", "itm_dog_mount"),
        (store_random_in_range, ":rand", 0, 3),
        (eq, ":rand", 0),
        (agent_play_sound, ":agent", "snd_dog_pant"),
        (assign, ":sound_played", 1),
      (end_try),
  ]),
      ...
      [
        ...
        (try_begin),
          (eq,":current_scene","scn_town_15_center"),
          (update_material, "@snow", "@ground_beach_wet"),
          (update_material, "@pebbles", "@ground_beach_pebbles"),
          (update_material, "@ground_desert", "@ground_beach"),
        (try_end),
      ]),
...
#        (eq, "$g_disable_flying_birds", 0),
        (assign, ":var1", "spr_birds_golub_flight"),
...
#          (prop_instance_set_vertex_keys_time_point, ":var4", ":var5"),
          (val_add, ":var5", 1),
          (try_begin),
            (ge, ":var5", 26),
            (assign, ":var5", 1),
    ...
    [
      ...
      (try_begin),
#        (eq, "$g_disable_flying_birds", 0),
        (assign, ":var1", "spr_birds_woron_flight"),
        (scene_prop_get_num_instances, ":var2", ":var1"),
        (ge, ":var2", 1),
        (try_for_range, ":var3", 0, ":var2"),
          (scene_prop_get_instance, ":var4", ":var1", ":var3"),
...
#          (prop_instance_set_vertex_keys_time_point, ":var4", ":var5"),
    ...
    [
      ...
      (try_begin),
#        (eq, "$g_disable_flying_birds", 0),
        (assign, ":var1", "spr_birds_seagull_flight"),
        (scene_prop_get_num_instances, ":var2", ":var1"),
        (ge, ":var2", 1),
        (try_for_range, ":var3", 0, ":var2"),
          (scene_prop_get_instance, ":var4", ":var1", ":var3"),
...
#          (prop_instance_set_vertex_keys_time_point, ":var4", ":var5"),
    ...
    [
      ...
      (assign, ":var0", 1),
      (try_begin),
        (try_for_range, ":var1", "spr_birds_woron_flight", "spr_birds_marker_woron_flight"),
          (scene_prop_get_num_instances, ":var2", ":var1"),
          (ge, ":var2", 1),
          (assign, ":var0", 0),
          (try_for_range, ":var3", 0, ":var2"),
...
#                (prop_instance_set_vertex_keys_time_point, ":var4", ":var16"),
              (try_end),
            (try_end),
          (try_end),
        (try_end),
...
#used for tournament master scene
      ...
      (56, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_practice_sword, itm_practice_shield, itm_padded_cloth, itm_hairband_universal_jawa_a]),
      (57, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_practice_sword, itm_practice_shield, itm_padded_cloth, itm_hairband_universal_jawa_a]),
    ],
    tournament_triggers
  ),
  ...
  (
    ...
    [
      ...
      (ti_before_mission_start, 0, 0, [],
       ...
       (ti_before_mission_start, 5, 0, [], # h 1200 climas batallas multijugador
       [

		 (store_current_scene,":current_scene"),
		 (try_begin),
			(eq,":current_scene","scn_quick_battle_scene_1"),
			(assign,"$g_time_of_day",12),
                       (play_sound,"snd_plain_ambiance_day"),
#                        (store_random_in_range, ":fog_distance", 790,800),
#                        (set_fog_distance, ":fog_distance", 0x919293),
#                        (store_random_in_range, ":rain_power", 0,1),
 		(else_try),
                        (eq,":current_scene","scn_quick_battle_scene_2"),
			(assign,"$g_time_of_day",10),
                        (play_sound,"snd_ocean_ambiance"),
                        (play_sound,"snd_plain_birds"),
                        (update_material, "@snow", "@ground_beach"),
                        (update_material, "@pebbles", "@ground_beach_pebbles"),
                        (update_material, "@ground_desert", "@ground_beach_wet"),
 		(else_try),
    ...
    [
      ...
      (ti_before_mission_start, 0, 0, [],
       ...
       [
		 ...
		 (store_current_scene,":current_scene"),
		 (try_begin),
			(eq,":current_scene","scn_quick_battle_scene_5"),
			(assign,"$g_time_of_day",15),
                        #(play_sound,"snd_plain_ambiance_day"),
                        (set_skybox, 48, 45),
                        (store_random_in_range, ":fog_distance", 990,1000),
                        (set_fog_distance, ":fog_distance", 0x9D9899),
       ...
       [
         ...
         (try_for_range, ":player_no", 0, ":num_players"),
           ...
           (try_begin),
             ...
             (this_or_next|eq, ":item_id", "itm_courser"),
             (eq, ":item_id", "itm_courser"),
  ...
  ###############################################
    ...
    dplmc_horse_cull + [      
		...
		[
            ...
            (try_begin),
              #SB : change conditions
              (agent_is_human, ":agent_no"),
              (agent_is_human, ":attacker_no"),
              (agent_get_troop_id, ":attacker_troop_id", ":agent_no"), #actually the one getting hit
              (store_random_in_range, ":random", 0, 60), #one roll at start
              (lt, ":random", 6), #disregard all this code if the 1/10 roll would fail anyway
              (assign, ":sound_id", -1), #invalid id
              (try_begin),
                ...
                (try_begin),
                  (lt, ":random", 6),
                  (assign, ":sound_id", ccoop_noble_sounds_start),
                (try_end),
              (else_try),
              ...
              (else_try),
                ...
                (try_end),
              (else_try), #SB : steppe bandits, pushed above generics
                (is_between, ":attacker_troop_id", "trp_steppe_bandit", "trp_manhunter"),
                (try_begin), #could also use this for low-level khergits
                  (eq, ":random", 0),
              ...
              (else_try), #SB : encounter_vaegir, use for high-level knights
                ...
                (try_begin),
                  (eq, ":random", 0),
                  (store_random_in_range, ":sound_id", "snd_encounter_vaegirs_ally", "snd_sneak_town_halt"),
                (try_end),
              (try_end),
              
              #SB : unified script call
              (try_begin),
                (agent_get_position, pos60, ":agent_no"),
            ...
            (else_try),
              ...
              (try_begin),
                (agent_is_human, ":attacker_no"),
                (agent_is_human, ":agent_no"),
                (agent_get_item_slot, ":agent_boots", ":attacker_no", ek_foot),
