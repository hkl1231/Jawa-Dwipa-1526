...
##    
 ...
 #   ),
    ...
    ("pistol_smoke", psf_billboard_3d, "prtcl_dust_a",
     100, 3.5, 0.6, -0.1, 80.0, 2.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.6, 1), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 1.5),   (0.5, 11.0),   #scale keys
     (0.4, 0.2, 0.1),           #emit box size
     (2, 2, 0),                 #emit velocity
     0.1                        #emit dir randomness
    ),
    ("musket_flash", psf_billboard_3d | psf_randomize_size , "flash_white1",
   ...
   ("pan_flash", psf_billboard_3d | psf_randomize_size , "flash_white1",
  ...
  ("musket_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "flash_white1",
     10, 0.7, 0.2, 0, 10.0, 0.02,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
...
#*-*-*-*-* D U M M Y *-*-*-*-#
    ...
    ("metal_hit", psf_randomize_size | psf_randomize_rotation,  "prt_sparks_mesh_1",
     500, 1, 2, 0.9, 10, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),          #alpha keys
     (0.1, 0.6), (1, 0.6),      #red keys
     (0.1, 0.5),(1, 0.5),       #green keys
...
##### Dungeon Water Drops  END #####
    ...
    ("firearm_flashpan_fire", psf_billboard_3d|psf_randomize_rotation, "prt_sparks_mesh_1",
    ...
    ("cannon_smoke", psf_billboard_3d|psf_randomize_rotation, "prtcl_dust_b",
    ...
    ("cannon_ball_hit", psf_billboard_3d|psf_randomize_size,  "prt_mesh_dust_1",
  ...
  ("explosion_smoke_white1", psf_billboard_3d|psf_billboard_drop, "prt_mesh_smoke_2",
    ...
    (0, 1), (1, 1),     #green keys
    (0, 1), (1, 1),    #blue keys
    (0, 7), (0.8, 10),  #scale keys
    (0, 0, 0),        #emit box size
    (3, 0, 8.5),        #emit velocity
    7                       #emit dir randomness         
  ),

   ("ground_particles", psf_randomize_size | psf_randomize_rotation,  "prt_ground_particles",
     1000, 5, 2, 1, 10, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),          #alpha keys
     (0.1, 0.6), (1, 0.6),      #red keys
     (0.1, 0.5),(1, 0.5),       #green keys
     (0.1, 0.4), (1, 0.4),      #blue keys
     (0.0, 0.4),   (0.2, 1),    #scale keys
  ...
  ("water_hit_b", psf_global_emit_dir|psf_turn_to_velocity|psf_randomize_rotation|psf_randomize_size, "prtcl_splash_b",
    ...
    ("ench_arrow_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
    ...
    ("ench_arrow_fire_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_mesh_fire_2",
     30, 1.5, 0.2, 0, 10.0, 0.02,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.66, 1), (1, 0),          #alpha keys
     (0.1, 0.7), (1, 0.7),      #red keys
     (0.1, 0.8),(1, 0.8),       #green keys
     (0.1, 1), (1, 1),      #blue keys
     (0.1, 0.05),   (1, 0.05),  #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (0, 0, 0.9),               #emit velocity
