...
("world_map", 0, mesh_load_window, [
	...
	# any map will be re-scaled to this map view
        (assign, ":min_map_x", -565*1000),
        (assign, ":max_map_x", 565*1000),
        (assign, ":min_map_y", -225*1000),
        (assign, ":max_map_y", 225*1000),
        ...
        (assign, ":party_move_length_x", 6500),
        (assign, ":party_move_length_y", 4800),
      ...
      ## initialization part end
        ...
        (try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
          ...
          (overlay_set_position, reg0, pos1),
          # size: 35*25
          (position_set_x, pos1, 25*40),
          (position_set_y, pos1, 15*40),
          (overlay_set_size, reg0, pos1),
          # kingdom name
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_banten_knight"),
      (else_try),
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_majapahit_knight"),
      (else_try),
        (assign, ":cur_troop", "trp_portugal_knight"),
      (try_end),
...
# DUNDE's VERSION of custom_banner presentation
# Set "$assigned_troop" to "trp_player" before call this presentation to change your banner
# Set "$assigned_troop" to "trp_npcxx"  before call this presentation to change your companion xx's banner
("custom_banner",0, mesh_load_window,
 [(ti_on_presentation_load,
   [(presentation_set_duration, 60000),
    (set_fixed_point_multiplier, 1000),
    # Title
    ...
    (create_text_overlay, reg0, "@Banner Customization", tf_center_justify), (overlay_set_color, reg0, 0x000000),
    (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos2),
    (position_set_y, pos1, 649),  (position_set_x, pos1, 499),  # Tittle Position
    (create_text_overlay, reg0, "@Banner Customization", tf_center_justify), (overlay_set_color, reg0, 0xFF0000),
    (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos2),   
    # Create Static Texts
    (assign, ":cur_y", 600), (position_set_x, pos3, 600), (position_set_y, pos3, 600),
    (try_for_range, ":pointer", "@Background Type", "@Banner Customization"),
       (store_sub, ":cur_y1", ":cur_y", 1),
       (create_text_overlay, reg0, ":pointer", tf_left_align), (overlay_set_color, reg0, 0x000000),
       (position_set_x, pos1,  15), (position_set_y, pos1, ":cur_y"),  (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos3),   
       (create_text_overlay, reg0, ":pointer", tf_left_align), (overlay_set_color, reg0, 0xFFFF00),
       (position_set_x, pos1,  14), (position_set_y, pos1, ":cur_y1"), (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos3),   
       (val_sub, ":cur_y", 35),
    (try_end),
    # Create Objects
    (create_combo_label_overlay, "$g_presentation_obj_1"), #type
    (create_combo_label_overlay, "$g_presentation_obj_2"), #charge pos
    (create_combo_label_overlay, "$g_presentation_obj_3"), #charge num
    (create_combo_label_overlay, "$g_presentation_obj_4"), #charge no
    (create_combo_label_overlay, "$g_presentation_obj_5"), #charge pic
    (create_game_button_overlay, "$g_presentation_obj_6", "@Horizontal", tf_center_justify),
    (create_game_button_overlay, "$g_presentation_obj_7", "@Vertical", tf_center_justify),    
    (create_combo_label_overlay, "$g_presentation_obj_8"), 
    (create_number_box_overlay,  "$g_presentation_obj_9",  0, 256), # R    
    (create_number_box_overlay,  "$g_presentation_obj_10", 0, 256), # R    
    (create_number_box_overlay,  "$g_presentation_obj_11", 0, 256), # R    
    (create_number_box_overlay,  "$g_presentation_obj_12", 0, 256), # G    
    (create_number_box_overlay,  "$g_presentation_obj_13", 0, 256), # G    
    (create_number_box_overlay,  "$g_presentation_obj_14", 0, 256), # G    
    (create_number_box_overlay,  "$g_presentation_obj_15", 0, 256), # B    
    (create_number_box_overlay,  "$g_presentation_obj_16", 0, 256), # B    
    (create_number_box_overlay,  "$g_presentation_obj_17", 0, 256), # B 
    (create_combo_label_overlay, "$g_presentation_obj_18"), #flag type
    (create_combo_label_overlay, "$g_presentation_obj_19"), #map flag type 
    (create_game_button_overlay, "$g_presentation_obj_20", "@Done", tf_center_justify),
    (create_game_button_overlay, "$g_presentation_obj_21", "@Randomize", tf_center_justify), 
    # Rearrange Objects    
    ...
    (position_set_y, pos1, 595-4*35), (overlay_set_position, "$g_presentation_obj_5",  pos1), (overlay_set_size, "$g_presentation_obj_5",  pos3), 
    (position_set_x, pos1, 130), (position_set_x, pos3, 300), (position_set_y, pos3, 400),
    (position_set_y, pos1, 598-6*35), (overlay_set_position, "$g_presentation_obj_9",  pos1), (overlay_set_size, "$g_presentation_obj_9",  pos3),
    (position_set_y, pos1, 598-7*35), (overlay_set_position, "$g_presentation_obj_10", pos1), (overlay_set_size, "$g_presentation_obj_10", pos3),
    (position_set_y, pos1, 598-8*35), (overlay_set_position, "$g_presentation_obj_11", pos1), (overlay_set_size, "$g_presentation_obj_11", pos3),
    (position_set_x, pos1, 200),
    (position_set_y, pos1, 598-6*35), (overlay_set_position, "$g_presentation_obj_12", pos1), (overlay_set_size, "$g_presentation_obj_12", pos3),
    (position_set_y, pos1, 598-7*35), (overlay_set_position, "$g_presentation_obj_13", pos1), (overlay_set_size, "$g_presentation_obj_13", pos3),
    (position_set_y, pos1, 598-8*35), (overlay_set_position, "$g_presentation_obj_14", pos1), (overlay_set_size, "$g_presentation_obj_14", pos3),
    (position_set_x, pos1, 270),
    (position_set_y, pos1, 598-6*35), (overlay_set_position, "$g_presentation_obj_15", pos1), (overlay_set_size, "$g_presentation_obj_15", pos3),
    (position_set_y, pos1, 598-7*35), (overlay_set_position, "$g_presentation_obj_16", pos1), (overlay_set_size, "$g_presentation_obj_16", pos3),
    (position_set_y, pos1, 598-8*35), (overlay_set_position, "$g_presentation_obj_17", pos1), (overlay_set_size, "$g_presentation_obj_17", pos3),
    (position_set_x, pos3, 50), (position_set_y, pos3, 30),
    (position_set_x, pos1, 235),(position_set_y, pos1, 598-5*35), (overlay_set_position, "$g_presentation_obj_6",  pos1), (overlay_set_size, "$g_presentation_obj_6",  pos3),
    (position_set_x, pos1, 335),(position_set_y, pos1, 598-5*35), (overlay_set_position, "$g_presentation_obj_7",  pos1), (overlay_set_size, "$g_presentation_obj_7",  pos3),
    (position_set_x, pos1, 950),   (position_set_x, pos3, 600), (position_set_y, pos3, 600),
    (position_set_y, pos1, 440),   (overlay_set_position, "$g_presentation_obj_18", pos1), (overlay_set_size, "$g_presentation_obj_18", pos3),
    (position_set_y, pos1, 440-35),(overlay_set_position, "$g_presentation_obj_19", pos1), (overlay_set_size, "$g_presentation_obj_19", pos3),
    (position_set_y, pos1, 440-70),(overlay_set_position, "$g_presentation_obj_8", pos1),(overlay_set_size, "$g_presentation_obj_8", pos3),
    # Rearrange Buttons
    (position_set_y, pos1, 25),  
    ...
    # Values possible
    (try_for_range, ":type",  custom_banner_backgrounds_begin, custom_banner_backgrounds_end),
       (store_sub, reg0, ":type",  custom_banner_backgrounds_begin),
       (val_add, reg0, 1), # Start with 1 for comfortable reading
       (overlay_add_item, "$g_presentation_obj_1", "@Theme {reg0}"),
    (try_end),
    (call_script, "script_get_troop_custom_banner_num_positionings", "$assigned_troop",),
    (assign, ":num_positionings", reg0),
    (try_for_range, ":cur_positioning", 0, ":num_positionings"),
       (store_add, reg0, ":cur_positioning",1), # Start with 1 for comfortable reading
       (overlay_add_item, "$g_presentation_obj_2", "@Arrangement {reg0}"),
    (try_end),
    (troop_get_slot, ":cur_positioning", "$assigned_troop", slot_troop_custom_banner_positioning),
    (val_clamp, ":cur_positioning", 0,  ":num_positionings"),
    (overlay_set_val, "$g_presentation_obj_2", ":cur_positioning"),
    (try_for_range, reg0, 0, 5),
       (try_begin),
          (eq, reg0, 0), (overlay_add_item, "$g_presentation_obj_3", "@No Charge"),
       (else_try),
          (eq, reg0, 1), (overlay_add_item, "$g_presentation_obj_3", "@{reg0} Charge"),
       (else_try),   
          (overlay_add_item, "$g_presentation_obj_3", "@{reg0} Charges"),
       (try_end),   
    (try_end),
    (troop_get_slot, ":num_charges", "$assigned_troop", slot_troop_custom_banner_num_charges), (overlay_set_val, "$g_presentation_obj_3", ":num_charges"),
    (try_for_range, ":cur_positioning", 0, ":num_charges"),
        (store_add, reg0, ":cur_positioning",1), # Start with 1 for comfortable reading
        (overlay_add_item, "$g_presentation_obj_4", "@Charger no {reg0}"),
    (try_end),
    (try_for_range, ":type",  custom_banner_charges_begin, custom_banner_charges_end),
       (store_sub, reg0, ":type",  custom_banner_charges_begin),
       (val_add, reg0, 1), # Start with 1 for comfortable reading
       (overlay_add_item, "$g_presentation_obj_5", "@Pic {reg0}"),
    (try_end),
    (try_for_range, ":type",  custom_banner_flag_types_begin, custom_banner_flag_types_end),
       (store_sub, reg0, ":type",  custom_banner_flag_types_begin),
       (val_add, reg0, 1), # Start with 1 for comfortable reading
       (overlay_add_item, "$g_presentation_obj_18", "@Flag Type {reg0}"),
    (try_end),
    (try_for_range, ":type",  custom_banner_flag_map_types_begin, custom_banner_flag_map_types_end),
       (store_sub, reg0, ":type",  custom_banner_flag_map_types_begin),
       (val_add, reg0, 1), # Start with 1 for comfortable reading
       (overlay_add_item, "$g_presentation_obj_19", "@Map Flag Type {reg0}"),
    (try_end),
    # Collecting Data
    (overlay_set_val, "$g_presentation_obj_4", "$assigned_charge"),
    (troop_get_slot, ":bg_type", "$assigned_troop", slot_troop_custom_banner_bg_type),
    (val_max, ":bg_type", 0), (overlay_set_val, "$g_presentation_obj_1", ":bg_type"), 
    (troop_get_slot, ":flag_type", "$assigned_troop", slot_troop_custom_banner_flag_type),
    (try_begin),
        (lt, ":flag_type", 0),
        (assign, ":flag_type", 0),
        (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_flag_type, 0),
    (try_end),    
    (overlay_set_val, "$g_presentation_obj_18", ":flag_type"),
    (troop_get_slot, ":map_flag_type", "$assigned_troop", slot_troop_custom_banner_map_flag_type),
    (try_begin),
        (lt, ":map_flag_type", 0),
        (assign, ":map_flag_type", 0),
        (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_map_flag_type, 0),
    (try_end),    
    (overlay_set_val, "$g_presentation_obj_19", ":map_flag_type"),
    (troop_get_slot, ":bg_color1", "$assigned_troop", slot_troop_custom_banner_bg_color_1),
    (store_and, ":color", ":bg_color1", 0xFF),     (overlay_set_val, "$g_presentation_obj_16", ":color"),   
    (store_and, ":color", ":bg_color1", 0xFF00),   (val_rshift, ":color", 8),  (overlay_set_val, "$g_presentation_obj_13", ":color"),
    (store_and, ":color", ":bg_color1", 0xFF0000), (val_rshift, ":color",16),  (overlay_set_val, "$g_presentation_obj_10", ":color"),
    (troop_get_slot, ":bg_color2", "$assigned_troop", slot_troop_custom_banner_bg_color_2),
    (store_and, ":color", ":bg_color2", 0xFF),     (overlay_set_val, "$g_presentation_obj_17", ":color"),   
    (store_and, ":color", ":bg_color2", 0xFF00),   (val_rshift, ":color", 8),  (overlay_set_val, "$g_presentation_obj_14", ":color"),
    (store_and, ":color", ":bg_color2", 0xFF0000), (val_rshift, ":color",16),  (overlay_set_val, "$g_presentation_obj_11", ":color"),
    (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_type_1),
    (troop_get_slot, ":active_charge", "$assigned_troop", ":slot"), (val_and, ":active_charge", 0xFF), 
    (overlay_set_val, "$g_presentation_obj_5", ":active_charge"),
    (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_color_1),
    (troop_get_slot, ":active_color", "$assigned_troop", ":slot"),
    (store_and, ":color", ":active_color", 0xFF),     (overlay_set_val, "$g_presentation_obj_15", ":color"),   
    (store_and, ":color", ":active_color", 0xFF00),   (val_rshift, ":color", 8),  (overlay_set_val, "$g_presentation_obj_12", ":color"),
    (store_and, ":color", ":active_color", 0xFF0000), (val_rshift, ":color",16),  (overlay_set_val, "$g_presentation_obj_9", ":color"),
    (val_add, ":flag_type", custom_banner_flag_types_begin),
    (store_add, ":map_flag", ":map_flag_type", "tableau_custom_banner_square"),    
    (val_add, ":map_flag_type", custom_banner_flag_map_types_begin), #custom_banner_sample_begin),
    # Items
    (assign, ":color", 0),
    (try_for_range, ":slot", 0, "itm_items_end"),
       (item_slot_eq, ":slot", slot_item_heraldic, 1),
       (val_add, ":color", 1),
       (troop_set_slot, "trp_temp_array_a", ":color", ":slot"),
    (try_end),
    (troop_set_slot, "trp_temp_array_a", 0, ":color"),
    (troop_get_slot, ":active_charge", "trp_temp_array_a", 0),
    (val_add, ":active_charge", 1), (assign, ":bg_color1", -1),
    (try_for_range, ":slot", 1, ":active_charge"),
        (troop_get_slot, ":color", "trp_temp_array_a", ":slot"),
        (str_store_item_name, s0, ":color"),
        (overlay_add_item,  "$g_presentation_obj_8", s0),
        (eq, ":color", "$assigned_item"),
        (store_sub, ":bg_color1", ":slot", 1),
    (try_end),
    (try_begin),
       (eq,  ":bg_color1", -1), (assign, ":bg_color1", 0),
       (troop_get_slot, "$assigned_item", "trp_temp_array_a", 1),
    (try_end),
    (overlay_set_val, "$g_presentation_obj_8", ":bg_color1"), 
    # Pictures
    (create_image_button_overlay_with_tableau_material, reg0, -1, "tableau_custom_banner_square_no_mesh", "$assigned_troop"),
    (position_set_x, pos1, 360), (position_set_y, pos1, 300), (overlay_set_position, reg0, pos1),
    (create_image_button_overlay_with_tableau_material, reg0, ":flag_type", "tableau_custom_banner_default", "$assigned_troop"),
    (position_set_x, pos3, 100), (position_set_y, pos3, 100), (position_set_x, pos1, 910), (position_set_y, pos1, 690),
    (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos3),
    (create_image_button_overlay_with_tableau_material, reg0, ":map_flag_type", ":map_flag","$assigned_troop"),
    (position_set_x, pos3, 100), (position_set_y, pos3, 100), (position_set_x, pos1, 670), (position_set_y, pos1, 320),
    (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos3),
    ...
    # Debug Mode
    (gt, "$debug_mode", 0),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_1", -200, 201),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_2", -200, 201),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_3", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_4", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_5", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_6", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_7", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_8", 0, 20001),
    (create_number_box_overlay,  "$g_presentation_obj_custom_battle_designer_9", 0, 4),
    # Position
    (position_set_y, pos1, 598-11*35), (position_set_x, pos3, 300), (position_set_y, pos3, 300),
    (position_set_x, pos1, 60),      (overlay_set_position, "$g_presentation_obj_custom_battle_designer_1", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_1", pos3), 
    (position_set_x, pos1, 60+1*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_2", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_2", pos3), 
    (position_set_x, pos1, 60+2*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_3", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_3", pos3), 
    (position_set_x, pos1, 60+3*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_4", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_4", pos3), 
    (position_set_x, pos1, 60+4*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_5", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_5", pos3), 
    (position_set_x, pos1, 60+5*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_6", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_6", pos3), 
    (position_set_x, pos1, 60+6*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_7", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_7", pos3), 
    (position_set_x, pos1, 60+7*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_8", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_8", pos3), 
    (position_set_x, pos1, 60+8*70), (overlay_set_position, "$g_presentation_obj_custom_battle_designer_9", pos1), (overlay_set_size, "$g_presentation_obj_custom_battle_designer_9", pos3),  
    # Values
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", "$debug1"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_2", "$debug2"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_3", "$debug3"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_4", "$debug4"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_5", "$debug5"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_6", "$debug6"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_7", "$debug7"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_8", "$debug8"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_9", "$debug9"),
  ...
  (ti_on_presentation_event_state_change, 
   [(store_trigger_param_1, ":object"),
    ...
    (try_begin), 
       (eq, ":object", "$g_presentation_obj_1"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_bg_type, ":value"),
    (else_try),   
       (eq, ":object", "$g_presentation_obj_2"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_positioning, ":value"),
    (else_try),       
       (eq, ":object", "$g_presentation_obj_3"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_num_charges, ":value"),
       (call_script, "script_get_troop_custom_banner_num_positionings", "$assigned_troop",),
       (assign, ":num_positionings", reg0),
       (troop_get_slot, ":cur_positioning", "$assigned_troop", slot_troop_custom_banner_positioning),
       (val_clamp, ":cur_positioning", 0,  ":num_positionings"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_positioning, ":cur_positioning"),
       (val_clamp, "$assigned_charge", 0, ":value"),
    (else_try),   
       (eq, ":object", "$g_presentation_obj_4"),
       (assign, "$assigned_charge", ":value"),
    (else_try),
       (eq, ":object", "$g_presentation_obj_5"),
       (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_type_1),
       (troop_get_slot, ":active_charge", "$assigned_troop", ":slot"),
       (val_and, ":active_charge", 0xF00),
       (val_or, ":active_charge", ":value"),       
       (troop_set_slot, "$assigned_troop", ":slot", ":active_charge"),
    (else_try),
       (eq, ":object", "$g_presentation_obj_6"),
       (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_type_1),
       (troop_get_slot, ":charge_type", "$assigned_troop", ":slot"),
       (store_mod, ":charge_type_base", ":charge_type", 512),
       (val_div, ":charge_type", 512),
       ...
       (val_mul, ":charge_type", 512),
       (val_add, ":charge_type", ":charge_type_base"),
       (troop_set_slot, "$assigned_troop", ":slot", ":charge_type"),
    (else_try),
       (eq, ":object", "$g_presentation_obj_7"),
       (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_type_1),
       (troop_get_slot, ":charge_type", "$assigned_troop", ":slot"),
    ...
    (else_try),
       (store_add, ":slot", "$assigned_charge", slot_troop_custom_banner_charge_color_1),
       (troop_get_slot, ":color", "$assigned_troop", ":slot"),
       (eq, ":object", "$g_presentation_obj_9"),
       (store_and, ":old_value", ":color", 0xFF0000),
       (val_rshift, ":old_value",16),
       (val_and, ":color", 0xFF00FFFF),
       (store_sub, ":diff", ":value", ":old_value"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", 0, 256),
       (val_lshift, ":value", 16),
       (val_or, ":color", ":value"),
       (troop_set_slot, "$assigned_troop", ":slot", ":color"),
    (else_try),
       (eq, ":object", "$g_presentation_obj_12"),
       (store_and, ":old_value", ":color", 0x00FF00),
       (val_rshift, ":old_value",8),
       (val_and, ":color", 0xFFFF00FF),
       (store_sub, ":diff", ":value", ":old_value"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", 0, 256),
    ...
    (else_try),
       ...
       (store_and, ":old_value", ":color", 0xFF),
       (val_and, ":color", 0xFFFFFF00),
       (store_sub, ":diff", ":value", ":old_value"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", 0, 256),
       ...
       (troop_set_slot, "$assigned_troop", ":slot", ":color"),
    (else_try),
       (troop_get_slot, ":color", "$assigned_troop", slot_troop_custom_banner_bg_color_1),
       (eq, ":object", "$g_presentation_obj_10"),
       (store_and, ":old_value", ":color", 0xFF0000),
       (val_rshift, ":old_value",16),
       (val_and, ":color", 0xFF00FFFF),
       ...
       (val_lshift, ":value", 16),
       (val_or, ":color", ":value"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_bg_color_1, ":color"),
    (else_try),
    ...
    (else_try),
       ...
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_bg_color_1, ":color"),
    (else_try),
       (troop_get_slot, ":color", "$assigned_troop", slot_troop_custom_banner_bg_color_2),
       (eq, ":object", "$g_presentation_obj_11"),
       (store_and, ":old_value", ":color", 0xFF0000),
       (val_rshift, ":old_value",16),
       (val_and, ":color", 0xFF00FFFF),
       ...
       (val_lshift, ":value", 16),
       (val_or, ":color", ":value"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_bg_color_2, ":color"),
    (else_try),
    ...
    (else_try),
       ...
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_flag_type, ":value"),
    (else_try),
       (eq, ":object", "$g_presentation_obj_19"),
       (troop_set_slot, "$assigned_troop", slot_troop_custom_banner_map_flag_type, ":value"),
    (else_try),   
       (eq, ":object", "$g_presentation_obj_20"),
       (assign, ":restart", 0),
       (presentation_set_duration, 0),
       (try_begin),
          (eq, "$assigned_troop", "trp_player"),
          (troop_get_slot, ":value", "trp_player", slot_troop_custom_banner_map_flag_type),
          (ge, ":value", 0),
          (val_add, ":value", custom_banner_map_icons_begin),
          (party_set_banner_icon, "p_main_party", ":value"),
        (try_end),
    (else_try),
       (eq, ":object", "$g_presentation_obj_21"),
       (call_script, "script_get_random_custom_banner", "$assigned_troop"), 
    (else_try),
       (eq, ":object", "$g_presentation_obj_8"),
       (val_add, ":value", 1),
    ...
    (else_try),
       (eq, ":object",  "$g_presentation_obj_custom_battle_designer_1"),
       (store_sub, ":diff", ":value", "$debug1"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", -200, 201),
       (assign, "$debug1", ":value"),
    (else_try),
       (eq, ":object",  "$g_presentation_obj_custom_battle_designer_2"),
       (store_sub, ":diff", ":value", "$debug2"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", -200, 201),
       (assign, "$debug2", ":value"),
    (else_try),
       (eq, ":object",  "$g_presentation_obj_custom_battle_designer_3"),
       (store_sub, ":diff", ":value", "$debug3"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", 0, 20001),
       (assign, "$debug3", ":value"),
    (else_try),
       (eq, ":object",  "$g_presentation_obj_custom_battle_designer_4"),
       (store_sub, ":diff", ":value", "$debug4"),
       (val_mul, ":diff", ":mul"),
       (val_add, ":value", ":diff"),
       (val_clamp, ":value", 0, 20001),
       (assign, "$debug4", ":value"),
 ...
 (ti_on_presentation_run, # Easter Eggs
  [(try_begin),
      (key_clicked, key_d), (val_add, reg19, 1),
      (try_begin),
           (neq, reg19, 1), (assign, reg19, 0),       
      (try_end),
   (else_try),
      (key_clicked, key_e), (val_add, reg19, 1),
      (try_begin),
           (neq, reg19, 2), (assign, reg19, 0),       
      (try_end),
   (else_try),
      (key_clicked, key_b), (val_add, reg19, 1),
      (try_begin),
           (neq, reg19, 3), (assign, reg19, 0),       
      (try_end),
   (else_try),
      (key_clicked, key_u), (val_add, reg19, 1),
      (try_begin),
           (neq, reg19, 4), (assign, reg19, 0),       
      (try_end),
   (else_try),
      (key_clicked, key_g), (val_add, reg19, 1),
      (try_begin),
         (neq, reg19, 5), (assign, reg19, 0),       
      (else_try),
         (val_add, "$debug_mode", 1), (val_and, "$debug_mode", 1),
         (eq, "$debug_mode", 1), 
         (assign, "$debug1", 0), (assign, "$debug2", 0),
         (assign, "$debug3", 5120), (assign, "$debug4", 5120), (assign, "$debug5", 10000), (assign, "$debug6", 10000),
         (assign, "$debug7", 10000), (assign, "$debug8", 10000), (assign, "$debug9", 0),
      (try_end),   
      (start_presentation, "prsnt_custom_banner"),          
   (try_end),  ]), ]),                
  ...
  ("banner_charge_positioning", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Change Position", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
        (assign, ":pos_x", 125),
  ...
  ("banner_charge_selection", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Choose Charge", tf_center_justify),
  ...
  ("banner_background_selection", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Choose Background Type", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
        (assign, ":pos_x", 75),
  ...
  ("banner_flag_type_selection", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Choose Flag Type", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
  ...
  ("banner_flag_map_type_selection", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Map Flag Type", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
  ...
  ("color_selection", 0, mesh_load_window,
   [
     (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
        (create_text_overlay, reg1, "@Choose Color", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
