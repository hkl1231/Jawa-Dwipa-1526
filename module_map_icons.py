...
map_icons = [
  ...
  ("village_a",mcn_no_shadow,"map_sunda_village_a", 0.45, 0),
  ("village_b",mcn_no_shadow,"map_village_b", 0.45, 0),
  ("village_c",mcn_no_shadow,"map_village_c", 0.45, 0),
  ("village_burnt_a",mcn_no_shadow,"map_sunda_village_a_burnt", 0.45, 0),
  ("village_deserted_a",mcn_no_shadow,"map_sunda_village_a_deserted", 0.45, 0),
  ...
  ("sunda_town_a",mcn_no_shadow,"map_sunda_a", 0.35,0),
  ("sunda_town_b",mcn_no_shadow,"map_sunda_b", 0.35,0),
  ("sunda_town_port_a",mcn_no_shadow,"map_sunda_harbor_a", 0.35,0),
  ("sunda_town_port_b",mcn_no_shadow,"map_sunda_harbor_b", 0.35,0),
  ("sunda_village_a",mcn_no_shadow,"map_sunda_village_a", 0.45, 0),
  ("sunda_village_burnt_a",mcn_no_shadow,"map_sunda_village_a_burnt", 0.45, 0),
  ("sunda_village_deserted_a",mcn_no_shadow,"map_sunda_village_a_deserted", 0.45, 0),
...
# DUNDE's BEGIN  
  ...
  ("custom_banner_02",0,"custom_map_banner_02a", banner_scale, 0,
   [
     (ti_on_init_map_icon,
      [
        (store_trigger_param_1, ":party_no"),
  ...
  ("custom_banner_03",0,"custom_map_banner_03a", banner_scale, 0,
   [
     (ti_on_init_map_icon,
      [
        (store_trigger_param_1, ":party_no"),
  ...
  ("custom_banner_04",0,"custom_map_banner_04a", banner_scale, 0,
   [
     (ti_on_init_map_icon,
      [
        (store_trigger_param_1, ":party_no"),
        ...
        (try_begin),
          ...
          (try_begin),
             ...
             (faction_get_slot, ":leader_troop", ":faction", slot_faction_banner),
          (try_end),
          (cur_map_icon_set_tableau_material, "tableau_custom_banner_flag", ":leader_troop"),
        (try_end),
        ]),
     ]),
# DUNDE's END
  ...
  ("banner_end",0,"map_flag_15", banner_scale,0),
