...
##Unify Demak begin
 ##Input1: Lords defeated
 ##Output1: Lord Defects at the final quest stage
##Unification of Jawa under Demak (We can start the quest if we start as king or being raised in rank as Patih or Marshall).
 ("demak_conquest_1", "Takeover Wirasari", 0,
  "The tensions between our kingdom and the Wilwatikta has come to its peak, a news spread that muslim community in Wirasari are getting persecuted by the local adipati. We have to act quickly to save those innocents from being subjects of greedy lord."
  ),
##Janggala
 ("demak_conquest_2", "Destroy the Majapahit", 0, ##Defeat atleast five lords or occupy three fortress or one city in each majapahit allies and the majapahit itself.
  "By occupying the Wirasari region, we have increased the tensions between our kingdom and other regions in eastern and central java. The Wilwatikta is recently allied himself with the Janggala regions and prepared to start their movement towards our kingdom. Defeat them, and we may earn our glory and stability."
  ),
 ##Output1: Rename Janggala regions to Giri Kedaton, and declare ally with demak and declare war with majapahit
 ##Output2: Pajang and Madura enters the war, Pajang declare ally with majapahit and war with demak, while madura declare ally with demak
##Pajang
 ("demak_conquest_3", "Destroy the Majapahit", 0, ##Defeat atleast five lords or occupy three fortress or one city in each majapahit allies and the majapahit itself.
  "Our growing power starts to worry the nearby regions, especially the Pajang region that now enters the war. But lucky for us, the Madura region joined our cause and declared war on the majapahit. Prepare to battle!."
  ),
 ##Output1: Change its lord to Jaka Tingkir or Raden Mas Karebet and declare ally with demak
 ##Output2: Kedu joins the war, Mataram allied with demak and change the ruler to Demak lord Ki Ageng Pamanahan
##Kedu
 ("demak_conquest_4", "Destroy the Majapahit", 0, ##Defeat atleast five lords or occupy three fortress or one city in each majapahit allies and the majapahit itself.
  "There is a civil war between islam that supported by traditionalists against hindu buddhist in Mataram region recently, and has won by the muslims. Now, they declare ally with us which surrounded the majapahit and we can force them to surrender. But this worries the Kedu regions and they declared war against mataram. Defeat them, and majapahit is about to fall."
  ),
 ##Output1: Change the lord of Kedu and declare ally with demak
 ##Output2: 
##Finale
 ("demak_conquest_5", "Destroy the Majapahit", 0, ##Defeat atleast five lords or occupy three fortress or one city in each majapahit allies and the majapahit itself.
  "The Majapahit refuse to surrender, Prabu Maudhara must be defated. Defeat his army and take over all of their settlement to achieve our glory once and for all."
  ),
 ##Output1: Blambangan declare war against Demak
 ##Output2: all regions unified its ownership to Demak through the aux script
##Unify Demak end
##Portuguese Start Colony Quest
 ##Input1:
 ##Output1:
##Portuguese Start Colony (We can start this quest only if we play as portuguese with noble start and can be started through asking one of our companion).
 ("portugal_conquest_1", "Build fort at Kalapa", 0,
  "Now we have arrived at Java, it's time to set up our fortification in the city of Calapa. Ask the King Surawisesa and the local lord of Calapa for Permission."
  ),
 ##Output1: change ownership of Kalapa to Portugal
 ##Output2: Cirebon and Banten declare war
##Cirebon and Banten unified and declare war on Portugal, defeat atleast three lords or occupy 2 settlements
 ("portugal_conquest_2", "Defeat the Cirebon and Banten", 0,
  "The Sultanate of Demak didn't seems to happy with our settlement here, and they prepared for war. Cirebon and Banten regions declared war on us today, defeat them and we can discuss for their land."
  ),
 ##Output1: Change ownership of Banten and Cirebon territories to Portugal
 ##Output2: Reinforce Portuguese

 ("portugal_conquest_3", "Portugal", 0,
  "."
  ),

 ("portugal_conquest_4", "Portugal", 0,
  "."
  ),

 ("portugal_conquest_5", "Portugal", 0,
  "."
  ),
