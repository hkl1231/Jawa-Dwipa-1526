...
##  ("cant_leave_now","Can't leave the area now."),
  ...
  ("1_denar", "1 kepeng"),
  ("reg1_denars", "{reg1} kepeng"),
  ("january_reg1_reg2", "Magha {reg1}, {reg2}"),
  ("february_reg1_reg2", "Phalguna {reg1}, {reg2}"),
  ("march_reg1_reg2", "Caitra {reg1}, {reg2}"),
  ("april_reg1_reg2", "Vaisakha {reg1}, {reg2}"),
  ("may_reg1_reg2", "Jyetsha {reg1}, {reg2}"),
  ("june_reg1_reg2", "Asadha {reg1}, {reg2}"),
  ("july_reg1_reg2", "Srawana {reg1}, {reg2}"),
  ("august_reg1_reg2", "Badrawada {reg1}, {reg2}"),
  ("september_reg1_reg2", "Asuji {reg1}, {reg2}"),
  ("october_reg1_reg2", "Kartika {reg1}, {reg2}"),
  ("november_reg1_reg2", "Margasira {reg1}, {reg2}"),
  ("december_reg1_reg2", "Posya {reg1}, {reg2}"),
...
#  ("relation_plus_90",  "                   Devoted"),
  ...
  ("acres_grain",       "acres of ricefield"),
  ("acres_orchard",     "acres of orchards"),
  ("acres_oasis",       "acres of irrigated ricefields"),
...
# Surname
  ("surname_1",  "{s50} Peteng"),
  ("surname_2",  "{s50} Wulung"),
  ("surname_3",  "{s50} Gandrung"),
  ("surname_4",  "{s50} Gandul"),
  ("surname_5",  "{s50} Wiryajaya"),
  ("surname_6",  "{s50} Giro"),
  ("surname_7",  "{s50} Kanigara"),
  ("surname_8",  "{s50} Prawata"),
  ("surname_9",  "{s50} Ametung"),
  ("surname_10", "{s50} Arok"),
  ("surname_11", "{s50} Cakrabuana"),
  ("surname_12", "{s50} Kusuma"),
  ("surname_13", "{s50} Manggala"),
  ("surname_14", "{s50} Santika"),
  ("surname_15", "{s50} Wiryadharma"),
  ("surname_16", "{s50} Prawira"),
  ("surname_17", "{s50} Keling"),
  ("surname_18", "{s50} Wilaga"),
  ("surname_19", "{s50} Tunggalreja"),
  ("surname_20", "{s50} Tunggulweton"),
  ("surname_21", "{s50} Sasmita"),
  ("surname_22", "{s50} Mulyana"),
  ("surname_23", "{s50} Bacok"),
  ("surname_24", "{s50} Tarok"),
  ("surname_25", "{s50} Bobok"),
  ("surname_26", "{s50} Gumelar"),
  ("surname_27", "{s50} Junaedi"),
  ("surname_28", "{s50} Kosasih"),
  ("surname_29", "{s50} Permana"),
  ("surname_30", "{s50} Gumilar"),
  ("surname_31", "{s50} Sutrisna"),
  ("surname_32", "{s50} Sutisna"),
  ("surname_33", "{s50} Subadra"),
  ("surname_34", "{s50} Danggala"),
  ("surname_35", "{s50} Raharja"),
  ("surname_36", "{s50} Mada"),
  ("surname_37", "{s50} Sudrajat"),
  ("surname_38", "{s50} Darajat"),
  ("surname_39", "{s50} Kasura"),
  ("surname_40", "{s50} Sura"),
  ("surname_41", "{s50} Jayamulang"),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 and you sit a throne in your own splendourous palace as one of the most powerful figures in Jawa."),
...
#npc16 = klethi
  ...
  ("npc1_intro", "What? who are you? what do you want? why are you looking at me like that?"),
  ("npc2_intro", "Hello. Would you be so kind to spare some ciu for me? I'm down to my last five kepeng and I'd rather not drink alone."),
  ("npc3_intro", "Good day to you!"),
  ("npc4_intro", "Hello there. I am Bagong Wulung, you can call me Astrajingga or Cepot if you wish, some people in kulon called me that."),
  ("npc5_intro", "Greetings, traveller. Would you join me for a drink?"),
  ("npc6_intro", "I am lost... Lost..."),
  ("npc7_intro", "Salaam 'alaykum? Keep your distance, please."),
  ("npc8_intro", "Bonjour, What do you want?"),
  ("npc9_intro", "You there, good {man/woman}, be so kind to give me some good meats from a baby, eh?"),
  ("npc10_intro", "Nuwun sewu rek! I am Paijo."),
  ("npc11_intro", "Uhh it's quite hot here compared to Malacca, i wonder how people could withstand this. Well anyway, my name is Catherine and i'm from Malacca."),
  ("npc12_intro", "Greetings, fellow traveller. Perhaps you can help me."),
  ("npc13_intro", "Greetings, traveller. I am Ahmed Samarqandi. No doubt you will have heard of me."),
  ...
  ("npc1_intro_response_1", "Why are you look so nervous?"),
  ("npc2_intro_response_1", "Your last five kepeng? What happened to you?"),
  ("npc3_intro_response_1", "Hello. What brings you to this trading post?"),
  ("npc4_intro_response_1", "Hmm... I have never heard of the Astrajingga or Cepot."),
  ("npc5_intro_response_1", "Certainly. With whom do I have the pleasure of drinking?"),
  ("npc6_intro_response_1", "Why so gloomy, friend?"),
  ("npc7_intro_response_1", "Pardon me. I was merely going to say that you look a bit down on your luck."),
  ("npc8_intro_response_1", "You don't speak like those portuguese folks from malacca, where are you from, good lady?"),
  ("npc9_intro_response_1", "Wait, what did you say?"),
  ("npc10_intro_response_1", "You seem very cheerful, what's the good news rek?"),
  ("npc11_intro_response_1", "Nice to meet you madam, so what's your story?"),
  ...
  ("npc1_intro_response_2", "Nevermind, i'm just passing by."),
  ("npc2_intro_response_2", "I have better things to do."),
  ("npc3_intro_response_2", "Run along now, girl. I have work to do."),
  ("npc4_intro_response_2", "Eh? sorry I'm not interested in some wayang shows right now."),
  ("npc5_intro_response_2", "I have no time for that."),
  ("npc6_intro_response_2", "No doubt. Well, good luck getting found."),
  ("npc7_intro_response_2", "Fine. I won't bother you, then."),
  ("npc8_intro_response_2", "I got no time for outsiders."),
  ("npc9_intro_response_2", "Fetch it yourself, you monster!"),
  ("npc10_intro_response_2", "Farewell."),
  ("npc11_intro_response_2", "Sorry i'm just passing by, madame."),
...
#backstory intro
  ...
  ("npc2_backstory_a", "It's a tragic tale, {sir/madame}."),
  ("npc3_backstory_a", "A good question, and I shall tell you!"),
  ("npc4_backstory_a", "Really? Well, perhaps your ignorance can be forgiven. In our story of Punakawan, Semar has three sons, Bagong or some folks from kulon called him Astrajingga or Cepot, Petruk or Dewala, and Gareng."),
  ("npc5_backstory_a", "I am Otong. Little story about me though as i'm an orphan raised by a farmer in the village of Situraja."),
  ...
  ("npc13_backstory_a", "You have not? Then perhaps you will have heard of my steed, who cuts across the Jawa plains like a beam of moonlight? Or of my sword, a connoisseur of the blood of the highest-born princes of the land?"),
...
#backstory main body
  ...
  ("npc5_backstory_b", "For as long as any one can remember, our people have feuded with the tribe of Humyan, many of whom have settled in the next valley over. Many men have died in this feud, on both sides, including two of my brothers. The Khan himself has ordered us to cease, to save men for the wars in Jawa. But I know my rights, and my brothers' blood cries out for vengeance. I waylaid and killed a Humyan on a track over the mountains, and I rode out of our village the same night, without even having had the chance to bid farewell to my father. I will bide my time in Jawa, for a year or two, then return home when the Khan's men have forgotten. The Humyan will not forget, of course, but such is the price of honour."),
...
#backstory recruit pitch
  ...
  ("npc7_backstory_c", "But I do not count myself unlucky, stranger, no more than any other woman of Jawa, this fetid backwater, this dungheap among the nations, populated by apes and jackals."),
...
### use these if there is a short period of time between the last meeting
  ...
  ("npc6_backstory_later", "I have been wandering Jawa, but have yet to find redemption."),
  ("npc7_backstory_later", "I have been wandering, looking for work as a tracker, but it has not been easy. Jawans are mostly ill-bred, lice-ridden, and ignorant, and it is not easy to work with such people."),
  ...
  ("npc13_backstory_later", "I have been wandering through the cities of Jawa, leaving a string of love-sick women and cuckolded husbands in my wake. But I grow weary of such simple challenges, and had been thinking of turning myself to more martial pastimes."),
...
#11
  ...
  ("npc13_morality_speech", "Captain, if we can avoid it, I'd prefer not to {s21}. Jawa is a small place, and one's reputation is precious. I would not care for one of my rivals to include this latest unfortunate incident in a satirical verse."),
...
### set off by behavior after victorious battle
  ...
  ("npc6_personalitymatch_speech", "Captain. Sometimes I am troubled by all this bloodshed, although I know that proud warlords must be humbled, and cruel bandits tamed, if we are to restore peace to Jawa."),
  ...
  ("npc1_personalitymatch_speech_b", "Without good honest souls like him to bring silver into Jawa, scoundrels like me would have a hard time in life, I'll warrant. I'm glad to have him with us."),
  ...
  ("npc12_personalitymatch_speech_b", "It saddens him deeply to take the lives of his fellow men, however just the cause. He and I have talked together of a brighter future, of the need to unite these petty warring kingdoms of Jawa, so that we may bring this time of troubles to an end."),
  ...
  ("npc7_retirement_speech", "I am tired of this squalid life of endless warfare, seeing men debased by fear, greed, lust, and a hundred other sins. I have money in my purse. I am going overseas to look for a better land than Jawa. I assume that you will fare well without me."),
  ...
  ("npc10_retirement_speech", "I've had enough of tromping up and down the length and breadth of Jawa. I've got enough to buy a small bit of land somewhere, so I think I'll give that a try. So long, and best of luck to you."),
  ...
  ("npc12_retirement_speech", "I've done all right in your company. I filled my belly, put some gold in my purse, and broadened my knowledge of wounds and injury -- I can't complain about that! But I think right now that service in this company is holding me back. I have a duty to share my findings with other surgeons, and for that I need to hire scribes, who are rare in Jawa. I shall be going home"),
  ...
  ("npc7_rehire_speech", "Captain! It is good to see you. Forgive what I may have said when we parted. I took a ship out of Wercheg, bound for the east, but it was taken by pirates and after my ransom I was set ashore back here. There may be better places in the world than Jawa, but I have yet to see them. So I think, if it is my lot to live here, then your company is as good a livelihood as any. Will you have me back?"),
  ...
  ("npc14_rehire_speech", "Captain. It is good to see you. When last we parted, I was ready to swear that I would not serve you again, but perhaps I judged you too harshly. All over Jawa, men sing your praises. I have tried serving in other lords' armies, and believe me, what I have seen of them restores my opinion of your leadership. If you would have me in your company, I would fight for you again."),
...
#local color strings
  ...
  ("npc9_home_intro", "Behold the Rock of Rivacheg! The strongest fortress in Jawa. My father was one of those who held the line here against the Nords, when they first tried to push inland from the coast."),
  ...
  ("npc8_home_description", "You haven't heard the story? When Gundig Hairy-Breeks came to Jawa from Nordland, he planted his banner on the headland and said that it would remain there until he recaptured his 'inheritance.' His 'inheritance', he called it. Gundig believed the skalds who told him that the Emperor had bequeathed Jawa to the Nords, when in fact he just gave us a small strip of land along the coast, so that we would crew his galleys."),
  ...
  ("npc11_home_description", "I'm from Uxkhal. You know the saying, {sir/madame} -- 'Barley grown in Uxkhal is made into ale in Praven, and we're all the better for it.' Not sure what that means, {sir/madame}, but it's true about the barley. And wheat, and oats. We grow more grain here in the Vale of Uxkhal then all the rest of Jawa put together, and our ale is the best, too. You can see it in the soil here -- rich and black, and smells of good harvests and full bellies."),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc8_home_description_2", "The skalds' tales at least gave Gundig an excuse to raise a warband -- not that we Nords ever need an excuse, mind. He sailed across the sea, rallied the Jawan Nords to his banner, and marched on the Rock of Rivacheg. The Vaegirs killed him, and threw his banner into the surf. But the Nords keep coming, and some day all of Jawa will be ours."),
  ...
  ("npc14_home_description_2", "If anyone were ever to unify this little land of ours, I'd sign up to serve them, free of charge. I'd put together an army of Rhodok spears with Nord footmen on the flanks and Vaegir archers in front, take along some Khergit scouts to find and fix the enemy, and some Swadian lancers and Sarranid mamlukes to finish them off. I'd take that army over the mountains and make the whole world kneel to Jawa.... Of course, that's what the Emperors thought, and in the end the tribes took away their Empire."),
  ("npc15_home_description_2", "And here's the funny thing -- when the Rhodok lands first rebelled against the Swadians, they all said they weren't going to have any noble lords ruling over them. You can guess how long that lasted. One Rhodok hill chieftain sets himself up in Culmarr, calls himself 'Count', and the good burghers of Jelkala and Veluca have to lick his boots if they want to sell their wine and velvet outside Jawa. And if you want to keep the counts under control, and the peasants providing the towns with food rather than selling to the highest bidder, then you need a King too, don't you? The Rhodok lands are no different than anyone else, whatever guff they talk about 'ancient liberties' and 'freedom.'"),
  ...
  ("npc9_home_recap", "I am from the Vaegir homeland over the mountains, where the Vaegir lords lived before the Emperor brought them in Jawa."),
  ...
  ("npc15_home_recap", "I'm from over the hills. But Jawa is where the money is to be made, these days, if your trade is siegecraft."),
  ...
  ("npc1_honorific", "agan"), #Borcha
  ("npc2_honorific", "{kakang/nyai}"), #marnid
  ("npc3_honorific", "{kakang/nyai}"), #ymira
  ("npc4_honorific", "kanjeng"), #rolf
  ("npc5_honorific", "agan"), #beheshtur
  ("npc6_honorific", "kanjeng"), #firentis
  ("npc7_honorific", "afwan"), #deshavi
  ("npc8_honorific", "monsieur"), #matheld
  ("npc9_honorific", "{kakang/nyai}"), #Alayen
  ("npc10_honorific", "{kakang/nyai}"), #Bunduk
  ("npc11_honorific", "senhor"), #katrin
  ("npc12_honorific", "{tuan/nanialap}"),
  ("npc13_honorific", "hazratim"), #nizar
  ("npc14_honorific", "patih"), #lazalit
  ("npc15_honorific", "{kakang/nyai}"), #artimenner
  ("npc16_honorific", "{kakang/nyai}"), #klethi

  ("npc1_kingsupport_1", "That's a great idea, Boss. All these kings and khans and landed nobles who rule now, with their prisons and gibbets and scaffolds, the whippings and brandings and hangings for any man who might be driven by the crying of his children to steal a loaf of bread, or maybe a horse -- Jawa deserves something better."), #Borcha
  ("npc2_kingsupport_1", "Well, captain -- I'd support you. I think you'd give Jawa the kind of enlightened rule which it has long needed."), #marnid
  ...
  ("npc9_kingsupport_2", "I would, {sir/madame}, and others would too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, Jawa's a mess -- the lord owns the land, except it's the king who owns the forest, but the city has the right to levy tax at its gates, and the commons can use the pastures on odd Tuesdays, except in Rivacheg when it's Wednesday. Who can remember? So I say you make things simple, like it was in the old days -- first the {king/sovereign}, then the lords, then everyone else."), #Alayen
  ("npc10_kingsupport_2", "Certainly, {Brother/Sister}. But I'd ask that you consider a thought of mine. If you became {king/queen}, then I'd ask you open your court to the common folks, and not just to the lords and blue-bloods. I'd ask you to let it be known that should any man be judged and sentenced, that he have the right to appeal to you directly. Right now, the lords have the right -- I say every man in Jawa should have it, too."), #Bunduk
  ...
  ("npc14_kingsupport_2", "I would indeed, sir. I think you can unite this land, and then we'll be able to raise an army such as Jawa has not seen for many generations -- Swadian lances, Vaegir archers, Rhodok spears, Sarranid swords, Nord axes, and Khergit skirmishers, and take it over the mountains to subdue all the lands that the Calradic emperors once held sway."), #lazalit
  ...
  ("npc8_kingsupport_3", "Good! Then give me a few weeks and I'll go about the courts of this land, letting it be known that you're a {king/ruler} who respects the thegns and their ancient rights. You won't go sticking your royal nose where it doesn't belong, and Jawa will be the better for it."), #matheld
...
#
  ...
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and give it a reputation that strikes fear in the hearts of thieves and brigands across Jawa. Thank you, {sire/madame}, for this opportunity."), #deshavi
  ...
  ("npc11_fief_acceptance", "Ay! You'd grant old Katrin a title of nobility? Well, I'd be daft to turn you down, now wouldn't I? My, the strange turns that life takes... Fancy this old bag of bones becoming a great peer of the realm of Jawa."), #katrin
  ("npc12_fief_acceptance", "Well, {sire/my lady}, I'd have you know that don't believe in the holding of land in fief to the king. Farmers and landholders should govern their own affairs, under the distant watch of the sovereign. That being said, Jawa has seen far too much bloodshed for us to turn the social order on its head right now. Give me that land, and I'll endeavor to prepare it for a brighter future -- if not in this generation, than perhaps in the next."), #jeremus
  ...
  ("npc13_turn_against", "It is sad to meet you as my enemy, Captain -- but on the other hand, to meet such a titan of the battlefield as yourself in combat is a rare privilege. Truly, the news of our contest today shall keep the bards and poets of Jawa in wine and silver for months to come, do you think?"), #nizar
  ("npc14_turn_against", "Well, {playername}. We meet as enemies. I confess that I have mixed feelings. It grieves me to make war on you, but if we meet in battle and I prevail, I will have defeated the worthiest foe in all Jawa, and I will know that my mastery of the military art is complete!"), #lazalit
...
("comment_intro_liege_affiliated", "I am told that you are pledged to one of the pretenders who disputes my claim to the crown of Jawa. But we may still talk."),
...
("comment_intro_noble_upstanding", "I see that you carry a nobleman's banner, but I do not recognize the device. No doubt you have come to Jawa in search of wealth and glory. If this indeed is the case, then I only ask that you show mercy to those poor souls caught in the path of war."),
...
("comment_intro_female_common_cunning", "It is not unheard-of for a {male/woman} to seek {his/her} fortune on the battlefields of Jawa, but neither is it usual. I shall be most interested in your progress."),
...
("rejoinder_intro_female_noble_sadistic", "Never mind my country. Here in Jawa, it seems, dogs lead {soldiers/men} to war."),
...
#steve post 0912 changes begin
  ...
  ("swadian_rebellion_pretender_intro",    "I am Sudhawarman, descendant of Purnawarman of the Sundapura Tarumanagara."),
  ("vaegir_rebellion_pretender_intro",     "My name is Raden Wanasera. son of Tumenggung Wijayasera, the rightful ruler of Caruban since the reign of Sanghyang Prabu Niskala Wastu Kancana."),
  ("khergit_rebellion_pretender_intro",    "I'am Susuhunan of Pontang, you don't have to know my name, that outsider bastard Maulana Hasanuddin has brought chaos to the serenity of tatar sunda!."),
  ("nord_rebellion_pretender_intro",       "I am Rakai Rangga Syailendra, the last descendants of Syailendrawangsa, the rightful ruler of the great Jawadwipa and Swarnabhumi."),
  ("rhodok_rebellion_pretender_intro",     "I am Raden Petir, the rightful King of the Mataram, who will free them from tyranny of that hindu bastards."),
  ("sarranid_rebellion_pretender_intro",   "I am Raden Arya Penangsang, the rightful ruler of Demak which Trenggana has taken from me."),



  ("swadian_rebellion_pretender_story_1",  "Upon the last breath of my father, he revealed that my family was the last remaining descendants of Purnawarman the great based on an old inscription of Sundawardhana, my family heirloom. After knowing that, i have a dream to reunite the great Sunda and kick out those outsiders from our land."),
  ("vaegir_rebellion_pretender_story_1",   "Cirebon was once a great civilization under the rule of Galuh Wastu Mandala, until Syarif Hidayatullah, the grandson of Sanghyang Sri Baduga Maharaja and Nyi Subang Larang from their daughter Nyi Rara Santang which is brought by an arabs to their land, then he return back here and appointed as Tumenggung of Caruban by Sanghyang Prabu Surawisesa."),
  ("khergit_rebellion_pretender_story_1",  "We the kanekes people have signed the treaty with that little King that we declare ouselves as part of his mandala Pajajaran with pride and glory to his name, until that bastard came and conquer the land, plundered our sacred groves and villages, brings chaos to our land with ignorance, as though their beliefs did not teach them to do such acts."),
  ("nord_rebellion_pretender_story_1",     "The Syailendrawangsa begins when Rakai Ratu Prabu Sanjaya, who gained the throne of Mataram and also the ruler of Sunda and Galuh at once. And i want to took back what my ancestors have struggled. "),
  ("rhodok_rebellion_pretender_story_1",   "That tyrant has gone too far in these troubled times, did they resolve the paregreg? did they really cares about the conditions of the people while they busy with their own business? No! they didn't, so i came in the name of mataram and all our ancestors who sailed the seven seas to restore what we believe and what rightfully ours."),
 ("sarranid_rebellion_pretender_story_1", "Ah, the question of rightful rulership is a matter of both history and perspective. Sultan Trenggana was indeed the Sultan of Demak, recognized as the rightful ruler by many of our people and traditional authorities. His reign was marked by strength and consolidation of power. However, as you know, in the shifting sands of politics and power, legitimacy can be challenged."),

  ("swadian_rebellion_pretender_story_2",  "Just after my father's death, Pajajaran was formed by Ratu Sanghyang Sri Baduga Maharaja Siliwangi who merged the twin kingdoms of sunda after being separated for long. Now that Pajajaran was ruled by one of his son Surawisesa, which is proven to be incompetent to rule as he never really accomplish any prestige upon his reign, and even inviting those foreigner who has taken Malaka and Pase to be his ally."),
 ...
 ("sarranid_rebellion_pretender_story_2", "My claim to the throne is rooted in my own lineage and the belief that the true continuation of our royal heritage is paramount. It is not just about who holds the title, but who can best lead and protect the realm. So, while Sultan Trenggana was seen as the legitimate ruler in his time, I believe that my claim represents the rightful continuation of our dynasty's legacy."),

  ("swadian_rebellion_pretender_story_3",  "Just look for yourself, Tegal Alang-alang now controlled by one of his siblings that is supported Demak and Surawisesa could not resolve this problem, even worse in Pontang which is now ruled by Cirebon prince Maulana Hasanuddin, breaking the peace that lasted hundreds of year in our lands."),
  ...
  ("sarranid_rebellion_pretender_story_3", "Initially, my position seemed promising. I was seen as a strong candidate with a legitimate claim, backed by my family and supporters. However, Sultan Trenggana's rise was characterized by a series of strategic alliances and military successes that consolidated his power. His ability to unite various factions and bring stability to Demak was undeniable. His effective governance and leadership skills won him the loyalty of many, which significantly undermined my claim."),

  ("swadian_rebellion_monarch_response_1", "Hahaha! and you really believe him, who again? SUDHAWARMAN? He and his stupid father Eroh Jumarsa or YUDHAWARMAN is the same, just a bollocks who knew nothing of Purnawarman's legacy and named themself warman to strenghten their claims. Listen, From what i know, all of Purnawarman's family died during the invasion of Sriwijaya and has no surviving descendant at all, land of Sunda was by then ruled by Sriwijaya's regents until Mahapralaya where the old kingdom of Chola stormed their capital."),
  ("vaegir_rebellion_monarch_response_1",  "Did wanasera talks to you? Perhaps there is a misconception. You better listen, i did not taken what's already his family owns, i was appointed by my grandfather to hold this region as Tumenggung and i did what i should do as a ruler as fair as possible. If i took what his family belongs and i am a foreigner or settler who invade their land, then why people of parahyangan or even Ratu Sanghyang Surawisesa my brother still respects me as their brother though our kingdom is at war?."),
  ...
  ("sarranid_rebellion_monarch_response_1", "Well, his claim to the throne is based on his own lineage and the support of certain factions. However, as I assumed leadership, my focus was on unifying Demak and addressing the various challenges facing the kingdom. This inevitably led to friction with those who felt marginalized or opposed to my rule."),

  ("swadian_rebellion_monarch_response_2", "You better not believe in such nonsense, i have no idea why a lot of people today making such claims and stated that they are the rightful ruler of sunda because of their noble ancestry or claiming that they are descendants of great peoples of old and this one is the nineth time i heard the same stupid nonsense from random people, though actually i know that those people's ancestors were actually farmers, plowman, or even a soldier."),
  ("vaegir_rebellion_monarch_response_2",  "Wisdom is achieved by patience and humility, not by parental lineage or even prestige of the past."),
  ...
  ("sarranid_rebellion_monarch_response_2", "Arya Penangsang, with his strong and ambitious nature, was a significant figure with his own vision for the future of Demak. His ambitions and discontent with my leadership led to a series of confrontations and conflicts. We had differing views on how the kingdom should be governed, and our political rivalry only intensified as we each sought to consolidate our power."),
...
#courtship
  ...
  ("kingdom_1_adjective",                     "Sunda"),
  ("kingdom_2_adjective",                     "Cirebon"),
  ("kingdom_3_adjective",                     "Banten"),
  ("kingdom_4_adjective",                     "Kedu"),
  ("kingdom_5_adjective",                     "Mataram"),
  ("kingdom_6_adjective",                     "Demak"),
  ("kingdom_7_adjective",                     "Pajang"),
  ("kingdom_8_adjective",                     "Wirasari"),
  ("kingdom_9_adjective",                     "Wilwatikta"),
  ("kingdom_10_adjective",                     "Tumapel"),
  ("kingdom_11_adjective",                     "Kahuripan"),
  ("kingdom_12_adjective",                     "Blambangan"),
  ("kingdom_13_adjective",                     "Madura"),
  ("kingdom_14_adjective",                     "Portugal"),
  ("kingdom_15_adjective",                     "Chinese"),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_well_i_believe_that_well_always_be_fighting__its_important_that_we_fight_for_a_rightful_cause", "You speak of unifying Jawa. Well, I believe that we'll always be fighting - it's important that we fight for a rightful cause."),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_well_youve_done_a_good_job_at_making_calradia_bend_its_knee_to_you_so_maybe_thats_not_just_talk", "You speak of unifying Jawa. Well, you've done a good job at making Jawa bend its knee to you, so maybe that's not just talk."),
  ("you_speak_of_unifying_calradia_id_be_impressed_if_i_thought_you_could_do_it_but_unfortunately_you_dont", "You speak of unifying Jawa. I'd be impressed if I thought you could do it. But unfortunately, you don't."),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_well_much_of_this_land_now_bends_its_knee_to_you_so_perhaps_that_is_not_just_talk", "You speak of unifying Jawa. Well, much of this land now bends its knee to you, so perhaps that is not just talk."),
  ("you_speak_of_unifying_calradia_but_right_now_yours_is_just_one_squabbling_faction_among_many", "You speak of unifying Jawa, but right now yours is just one squabbling faction among many."),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_well_many_have_said_that_you_might_very_well_be_the_one_to_do_it", "You speak of unifying Jawa. Well, many have said that, you might very well be the one to do it."),
  ("you_speak_of_unifying_calradia_well_all_the_kings_say_that_im_not_sure_that_you_will_succeed_while_they_fail", "You speak of unifying Jawa. Well, all the kings say that. I'm not sure that you will succeed while they fail."),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_you_may_indeed_humble_the_other_kings_of_this_land_and_in_that_case_i_would_hope_that_you_would_remember_me_as_your_faithful_servant", "You speak of unifying Jawa. You may indeed humble the other kings of this land, and in that case I would hope that you would remember me as your faithful servant."),
  ("you_speak_of_unifying_calradia_but_you_are_weak_and_i_think_that_you_will_remain_weak", "You speak of unifying Jawa. But you are weak, and I think that you will remain weak."),
...
#  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying Jawa. Well, maybe you can unite this land by the sword. But I'm not sure that this will make you a good ruler."),
  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying Jawa. Well, maybe you can unite this land by the {s14}. But I'm not sure that this will make you a good ruler."),
...
##diplomacy end+ (finish adding alternate cultural terms)
  ...
  ("you_speak_of_unifying_calradia_it_would_be_good_to_bring_peace_to_the_realm_and_i_believe_that_you_are_strong_enough_to_do_so", "You speak of unifying Jawa. It would be good to bring peace to the realm, and I believe that you are strong enough to do so."),
  ("you_speak_of_unifying_calradia_it_would_be_good_to_bring_peace_the_realm_but_with_your_kingdom_in_its_current_state_i_worry_that_you_are_just_bringing_more_discord", "You speak of unifying Jawa. It would be good to bring peace the realm, but with your kingdom in its current state, I worry that you are just bringing more discord."),
...
#diplomacy end+
  ...
  ("noble", "noble"),
  ("common", "common"),
  ("may_find_that_you_are_able_to_take_your_place_among_calradias_great_lords_relatively_quickly", "may find that you are able to take your place among Jawa's great lords relatively quickly"),
  ("may_face_some_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face some difficulties establishing yourself as an equal among Jawa's great lords"),
  ("may_face_great_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face great difficulties establishing yourself as an equal among Jawa's great lords"),
...
##diplomacy end+
  ...
  ("that_you_are_the_rightful_heir_to_the_throne_of_calradia", "That you are the rightful heir to the throne of Jawa?"),
  ("that_s14_is_the_rightful_ruler_of_calradia", "That {s14} is the rightful ruler of Jawa?"),
  ...
  ("khan", "raden"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom of the Jawans, {s45} should be {s47}"),
...
##diplomacy start+ gender correction
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in Jawa, {she/he} will organize the wedding feast."),
##diplomacy end+
...
##diplomacy end+
  ...
  ("you_will_not_be_disappointed_sirmadam_you_will_not_find_better_warriors_in_all_calradia", "You will not be disappointed {sir/madam}. You will not find better warriors in all Jawa."),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_player", "Raden {s0}"),
  ("faction_title_male_1", "Tumenggung {s0}"),
  ("faction_title_male_2", "Tumenggung {s0}"),
  ("faction_title_male_3", "Tumenggung {s0}"),
  ("faction_title_male_4", "Tumenggung {s0}"),
  ("faction_title_male_5", "Tumenggung {s0}"),
  ("faction_title_male_6", "Tumenggung {s0}"),

  ("faction_title_female_player", "Nyi {s0}"),
  ("faction_title_female_1", "Nyai {s0}"),
  ("faction_title_female_2", "Nyi {s0}"),
  ("faction_title_female_3", "Nyi {s0}"),
  ("faction_title_female_4", "Nyi {s0}"),
  ("faction_title_female_5", "Nyi {s0}"),
  ("faction_title_female_6", "Nyi {s0}"),
...
##diplomacy end+
  ...
  ("lord_indicted_dialog_rejected", "Indeed? Well, perhaps your reputation is misleading. Good day, {my lord/my lady} -- I go to see if another ruler in Jawa is more appreciative of my talents."),
...
##diplomacy end+
  ...
  ("quick_battle_scene_1", "Rancagelang"),
  ("quick_battle_scene_2", "Northern Shore"),
  ("quick_battle_scene_3", "Cimanuk"),
  ("quick_battle_scene_4", "Ratu Boko"),
  ("quick_battle_scene_5", "Trowulan"),
#  ("quick_battle_scene_4", "Abhayagiri"),
#  ("quick_battle_scene_5", "Trowulan"),
  ("quick_battle_scene_6", "Kedu Plains"),
  ("quick_battle_scene_7", "Merapi Foothills"),
#Sieges
  ("quick_battle_scene_8", "Dahanapura"),
  ("quick_battle_scene_9", "Demak"),
#  ("quick_battle_scene_8", "Abhayagiri"),
#  ("quick_battle_scene_9", "Trowulan"),
#Sea Battles
  ("quick_battle_scene_10", "Laut Jawa"),
  ("quick_battle_scene_11", "Cape of Good Hope"),
  ("quick_battle_scene_12", "Laut Kidul"),
  ("quick_battle_scene_13", "Blandongwati"),
  ("quick_battle_scene_14", "Sanggarah"),

  ("quick_battle_troop_1", "In the ancient forest's twilight, Bratasena, a warrior of legendary lineage, stood ready. Born under crimson stars, his destiny was to face the looming darkness and seek redemption. With his ancestral blade in hand, he prepared to carve his legend into history. Thus began the saga of Bratasena, a hero daring to challenge the shadows."),
  ("quick_battle_troop_2", "In the bustling port city of Demak, where the call to prayer intertwined with the sounds of the market, lived Teja Purwantara. A devout Muslim and a master of muskets, Teja's reputation as a sharpshooter was unmatched. Trained from a young age, his keen eye and steady hand made him a formidable guardian of his homeland. Teja's skill with the musket was not merely for show; it was his vow to protect the people of Demak from the encroaching threats. As tensions rose and shadows of conflict darkened the horizon, Teja stood ready. With faith in his heart and a musket in his hands, he embarked on a journey that would test his resolve and honor."),
  ("quick_battle_troop_3", "Alfonso de Beja, a seasoned Portuguese mercenary, left his war-torn homeland behind in search of fortune. His journey took him to the lush, vibrant lands of Sumatra and Malaya, where local lords vied for power and influence. With a sharp mind and unmatched skill with a blade, Alfonso sold his services to the highest bidders, becoming an indispensable asset in their battles and schemes. His reputation grew as he navigated the intricate web of alliances and rivalries, shaping the destinies of those who sought his aid."),
  ("quick_battle_troop_4", "Lutung Kapetung, a warrior from Rawa Badak, pledged his loyalty to the Pajajaran Kingdom. Renowned for his immense strength, he wielded the eccentric weapon, Bedog Gaplok, with unparalleled skill. His powerful arm and unique fighting style made him a legendary figure on the battlefield, striking fear into the hearts of his enemies. Devoted to his kingdom and his oath, Lutung Kapetung's bravery and might became the stuff of legend."),
  ("quick_battle_troop_5", "A cannoneer trained since the age of twelve, Singha Gendheng was known for his explosive personality as much as his skill with the Cetbang cannon. Hailing from a family of cannoneers, his aim was as true as his humor was wild. Despite his young age, Singha’s antics on the battlefield were legendary. He would often shout jokes at his enemies just before firing, leaving them laughing or bewildered before the inevitable boom of his cannon. His fellow soldiers never knew whether to brace for the blast or the punchline."),
  ("quick_battle_troop_6", "Maharaja Prabu Purnawarman, the illustrious ruler of Tarumanagara, commanded respect and reverence across his kingdom. Known for his wisdom and unwavering leadership, he guided his people through times of prosperity and hardship. His reign was marked by monumental achievements, including the construction of canals that brought life to the fields and prosperity to his subjects. With a keen sense of justice and a heart dedicated to his people, Purnawarman's legacy was one of strength and benevolence."),
  ("quick_battle_troop_7", "A professional officer stationed in Kadiri named Lembu Kasura, was renowned for his brilliant strategies and exceptional skill with a blade. His keen intellect and tactical prowess made him an indispensable asset to his commanders, guiding his forces to victory in numerous battles. Trained rigorously from a young age, Lembu's dedication to his craft was evident in every precise strike and calculated move. His reputation as a master strategist and formidable swordsman spread far and wide, earning him the respect and admiration of allies and foes alike. Thus began the storied career of Lembu Kasura, an officer whose brilliance and martial skill shaped the destiny of Kadiri and its people."),
  ("quick_battle_troop_8", "The revered goddess of rice and fertility in Javanese mythology, Dewi Sri embodies the essence of abundance and prosperity. Adored by farmers and villagers alike, she is believed to bring forth bountiful harvests and blessings to the land. Depicted as a radiant deity with a gentle demeanor, Dewi Sri's presence is felt during planting and harvest seasons, where prayers and offerings are made to ensure her favor. Her legend is intertwined with the cycle of life and the vital importance of agriculture in Indonesian culture."),
  ("quick_battle_troop_9", "Brata Arjuna, a name echoing with strength and nobility, was known throughout the realms for his unwavering courage and unyielding honor. Born into a lineage of warriors, he bore the responsibility of upholding his family's legacy with grace and prowess. From his youth, Brata Arjuna trained tirelessly in the arts of war, mastering the bow and sword with a skill that rivaled the legends of old. His presence on the battlefield inspired both fear and admiration among his allies and adversaries alike. Yet beyond his martial prowess, Brata Arjuna was known for his compassion and sense of justice. He stood as a beacon of hope for the oppressed and a stalwart defender of his people, earning him the respect of kings and commoners alike."),
  ("quick_battle_troop_10", "Maharani Amartawijaya, the enigmatic ruler of a forgotten kingdom lost to the annals of history, was revered for her unparalleled strength and indomitable spirit. Rising to power in a time of turmoil and uncertainty, she navigated the complexities of governance with wisdom and resolve. Known for her keen intellect and decisive leadership, Maharani Amartawijaya commanded loyalty and admiration from her subjects. Her reign was marked by prosperity and stability, as she defended her realm against external threats and fostered growth within its borders. Beyond her martial prowess, Maharani Amartawijaya was celebrated for her compassion and dedication to the well-being of her people. Her legacy endured through tales of her courage and fortitude, inspiring generations to come."),
  ("quick_battle_troop_11", "Jaka Tingkir or Joko Tingkir is a legendary figure in Javanese folklore, was known for his cunning intellect and strategic prowess. Rising from humble origins, he navigated the intricate web of court politics with astuteness and finesse. Renowned for his sharp wit and resourcefulness, Jaka Tingkir earned the trust of kings and commoners alike. His ability to outsmart adversaries and solve seemingly insurmountable challenges made him a revered hero in the hearts of the people. Beyond his strategic acumen, Jaka Tingkir was also admired for his integrity and commitment to justice. He wielded his influence not for personal gain, but for the betterment of his kingdom and its people."),
  ("quick_battle_troop_12", "Astrajingga, also known as Cepot in Sundanese wayang golek and Bagong in Javanese wayang kulit, is a beloved puppet character renowned for his humor and wisdom. Despite regional differences, both characters share a common essence of providing comedic yet insightful commentary. A theory suggests that Cepot and Bagong could be the same character from different fabric of reality or universe. Thus, Astrajingga's legacy endures as a symbol of humor and wisdom, bridging diverse traditions with his timeless appeal."),
  ("quick_battle_troop_13", "Gatotkaca, a legendary hero in Javanese and Balinese mythology, is known for his superhuman strength and ability to fly. Born from the union of a human and a celestial being, he possesses incredible powers that make him a formidable warrior. Clad in impenetrable armor, Gatotkaca's bravery and dedication to justice are celebrated in epic tales, making him a symbol of heroism and valor in Indonesian folklore. His exploits and unwavering courage continue to inspire generations, cementing his place as a timeless cultural icon."),
  ("quick_battle_troop_14", "A central figure in Javanese and Balinese mythology, is revered as a wise and benevolent guardian spirit. Semar, often depicted as a humble pot-bellied man with a kind demeanor, Semar serves as a spiritual guide and protector for heroes in wayang performances. Despite his simple appearance, he embodies profound wisdom and divine power, offering guidance and comfort to those in need. Semar's role as a mediator between the divine and the mortal realms underscores his importance in the world, where he symbolizes humility, wisdom, and the enduring power of good."),
  ("quick_battle_troop_15", "A legendary figure in Javanese history, Ken Arok or Ken Angrok rose from humble beginnings to become the founder of the Singhasari Kingdom. Known for his cunning and martial prowess, he overcame numerous challenges to claim the throne. His story is marked by intrigue and ambition, with his rise to power shaping the political landscape of medieval Java. Ken Angrok's legacy endures as a symbol of determination and strategic acumen, leaving an indelible mark on Indonesian history and folklore."),
  ("quick_battle_troop_15", "Mahapatih Gajah Mada, a legendary figure in Javanese history, was the powerful prime minister of the Wilwaktikta Mandala. Renowned for his strategic brilliance and unwavering ambition, Gajah Mada played a crucial role in expanding the mandala's influence across Southeast Asia. His famous Sumpah Palapa oath vowed to conquer and unify the archipelago under Wilwaktikta rule. Gajah Mada's legacy as a master strategist and unifier endures, symbolizing the zenith of Wilwaktikta's power."),
  ...
  ("comment_intro_liege_affiliated_to_player", "I am told that you would dispute my claim to the crown of Jawa. Needless to say, I am not pleased by this news. However, we may still talk."),
...
##diplomacy start+ todo xxx gender correct ##diplomacy end+
  ...
  ("journey_to_reyvadin", "You came by ship, in a rich and flourishing port in the northwest of the island. The land here is made of gold, and the forests are rich with fur-bearing game, and the rivers are teaming with fish. The riches of the city draw the traders and merchants from around the world, but the traders and merchants in turn draw bandits. You saw the occasional dark figure mounted on a black sailed jung, watching the passage of your caravan from the open sea, and were glad when the spires of Jayakarta came into view across the sea of java."),
  ("journey_to_praven", "You have come through the Priangan highlands in the heartland of Pasundan. Green shoots of ricefields, cassava and ancient trees are beginning to push through the red soil of the rolling hills, and on the lower slopes of the mountains, herds of cattle and sheep are grazing on the spring grass. Occasionally, too, you catch sight of one of the great pariaman warhorses that are the pride of the Sundanese nobility. The land here is rich -- but also troubled, as the occasional burnt-out farm bears witness. You keep a wide berth of the forests, where desperate men have taken refugee, and it is some relief when you crest a ridge and catch sight of the great timberwork city of Pakwan, its rooftops made golden by the last rays of the setting sun."),
  ("journey_to_jelkala", "Cirebon, the central base of Wali Sangha, the nine great teachers of islam in Java. You arrived by ship at the rich port of Cirebon, the people here are well fed and flourished with faith and trades. Although, it is a sundanese city, most of its people speaks javanese sounded language, which confused many traders who've disembarked at the city. Islam is dominated the area, many people here seems really enjoyed the rule of islam and its spread, first introduced by their current leader Sultan Syarif Hidayatullah or also known as Sunan Gunungdjati which is the grand son of Sri Baduga Maharaja known as Prabu Siliwangi, a former maharaja of Mandala Pajajaran, from his daughter Nyi Rara Santang, which legitimized his rule over the sundanese people through the blood that runs over his veins."),
  ("journey_to_sargoth", "The echoes of the Medang Empire still howls the city of Karta, as you arrived from the mountainous region of merapi and sindhara. You started ti hear the people shouting at the palace, demands their leader to abdicate as you pass through the city gate, it seems that the people here are starting to return to their old beliefs. Mass protest and violence is nothing new here since the light of Wilwaktikta has started to fade, but still bearing hope for stability as the ongoing war with the Demak is still haunting the people from military activity and raids to their villages."),
  ("journey_to_tulga", "You came by ship, in a rich and cultured port in the northern part of the island, the strait of muria can be seen from a far, splitting the so called mahameru or muria mountain from its mainland. The city of Bintoro was the capital and the central islamic culture in this island. Tolerance of religion here seems astonishing, its culture diversity makes it an easy things to do when it comes into tolerance as you see many of hindu-buddhist and tantra monks still walks around the city, with no trouble at all while blending in with the majority of muslim populace in the city. The city of Bintoro was the biggest producer of starfruit, the orchards span through the forests and plains marked its richness in food and resources."),
  ("journey_to_shariz", "As the shines of Mandala Wilwaktikta disintegrates, and so the struggling area of Kedu started to follow the same fate. You arrived from the mountainous plains of Kedu to the city of Budur, the greatest and largest buddhist temple that ever existed. The people here are struggling, local chiefs killed several times as the islamic sunans also spreading the words of prophet Muhammad become more problematic for the Buddhist cultured kingdom. The people here are also in chaos, protest and mass hostility is nothing new around here, many people have choosed to return to their old beliefs and some accepted islam. Ki Ageng Pamanahan is known to be active around here, spreading Islam in the middle of the angered population for their lavish and ignorant leader."),
...
("the_deserts", "the muria"),
("the_tundra", "the tundra"),
("the_forests", "the forests"),
("the_highlands", "the pasundan"),
("the_coast", "the coast"),
  ##diplomacy start+ make gender-correct
  ...
  ("s12s15_declared_war_to_control_calradia", "{s12}{s15} may attack {s16} without pretext, as a bid to extend control over all of Jawa."),
...
#diplomacy end+
  ("s21_the_s8_declared_war_as_part_of_a_bid_to_conquer_all_calradia", "{s21}. The {s8} declared war with very little pretext, as part of a bid to conquer all Jawa."),
...
###################################################################################
 ...
 #utility for keys array
  ...
  ##Wuan
  ("key_left_mouse_button", "Left Click"),
  ("key_right_mouse_button", "Right Click"),
  ("key_middle_mouse_button", "Middle Mouse Button"),
  ("key_mouse_button_4", "Mouse Button 4"),
  ("key_mouse_button_5", "Mouse Button 5"),
  ("key_mouse_button_6", "Mouse Button 6"),
  ("key_mouse_button_7", "Mouse Button 7"),
  ("key_mouse_button_8", "Mouse Button 8"),
  ("key_mouse_scroll_up", "Mouse Scroll Up"),
  ("key_mouse_scroll_down", "Mouse Scroll Down"), 
  ##Wuan
...
#mercenary hiring, reg65 = gender, s0 = sir/madam, reg1 = plural/singular
  ...
  ("mercenary_intro_2", "Well done, {s0}. Keep the money and wine coming {reg1?my:our} way, and there's no foe in Jawa you need fear."),
  ...
  ("mercenary_intro_4", "You will not be disappointed {s0}. You will not find {reg1?better warriors:a better fighter} in all Jawa."),
#bandit
...
#utility from CC for item modifiers
  ...
  ("faction_leader_title_male_player", "Raja {s0}"),
  ("faction_leader_title_male_1", "Sri Sanghyang {s0} Maharaja"),
  ("faction_leader_title_male_2", "Sri Raja {s0}"),
  ("faction_leader_title_male_3", "Raden {s0}"),
  ("faction_leader_title_male_4", "Rakai {s0}"),
  ("faction_leader_title_male_5", "Sultan {s0}"),
  ("faction_leader_title_male_6", "Sultan {s0}"),
  ("faction_leader_title_male_7", "Sultan {s0}"),
  ("faction_leader_title_male_8", "Raden {s0}"),
  ("faction_leader_title_male_9", "Prabu Batara {s0} Maharaja"),
  ("faction_leader_title_male_10", "Prabu {s0} Maharaja"),
  ("faction_leader_title_male_11", "Sunan Giri {s0}"),
  ("faction_leader_title_male_12", "Prabu {s0} Maharaja"),
  ("faction_leader_title_male_13", "Raden Adipati {s0}"),

  ("faction_leader_title_female_player", "Rani {s0}"),
  ("faction_leader_title_female_1", "Parmeswari {s0}"),
  ("faction_leader_title_female_2", "Nyi {s0}"),
  ("faction_leader_title_female_3", "Nyi {s0}"),
  ("faction_leader_title_female_4", "Dyah {s0}"),
  ("faction_leader_title_female_5", "Parmeswari {s0}"),
  ("faction_leader_title_female_6", "Nyi {s0}"),
  ("faction_leader_title_female_7", "Nyi {s0}"),
  ("faction_leader_title_female_8", "Dyah {s0}"),
  ("faction_leader_title_female_9", "Parmeswari {s0}"),
  ("faction_leader_title_female_10", "Parmeswari {s0}"),
  ("faction_leader_title_female_11", "Nyi {s0}"),
  ("faction_leader_title_female_12", "Parmeswari {s0}"),
  ("faction_leader_title_female_13", "Dyah {s0}"),

#Wuan  add bodysliding and remove the part that conflicts with it PBOD
  #settings
  #Wuan
  ("bdsld_setting_2", "All Troops"),
  ("bdsld_setting_1", "Only Companions"),
  ("bdsld_setting_0", "Disabled"),
  #Wuan
...
#  ("dplmc_setting_tt2a", "This option orders all your troops to use any weapons, fire at will, and charge once you fall in battle."),
  ("dplmc_setting_tt2", "This option gives advantage in autocalculated battles to those units who are better in the current terrain.^Horsemen are bad in forest terrain, while archers are better."),
  ("dplmc_setting_tt3", "This option lets exiled lords return in order to serve a new liege and form warbands without a home center."),
  ("dplmc_setting_tt4", "This option lets you decide the AI strength level. The higher this level is, the better the AI. High level is experimental and may brings some bugs to your game."),
  ("dplmc_setting_tt5", "This option changes the economical and behavior values to be more realistic. High level is experimental and may brings some bugs to your game."),
  ("dplmc_setting_tt6", "This option lets you decide the level of sexism in the game."),
#  ("dplmc_setting_tt8", "This option toggles whether companions suffer from incompatible moralities and grievance penalties."),
  ...
  #Wuan
  ("dplmc_setting_tt8", "This option enables a more complex disguise system while entering hostile centers."),
...
#Wuan 
  ...
  ("mayor_wealth_no_data", "All things considered, we are on par with all others towns in Jawa."),
  ...
  ("mayor_wealth_comparison_1", "Overall, the wealthiest town in Jawa is {s2}. {s1}"),
  ("mayor_wealth_comparison_2", "In terms of local industry, the most productive town in Jawa is {s2}. {s1}\
 Production is of course affected by the supply of raw materials, as well as by the overall prosperity of the town."),
  ("mayor_wealth_comparison_3", "In terms of the output of the surrounding villages, {s2} be the richest in Jawa. {s1}\
...
#MCA:
  ...
  ("accessory_bagsbottles_random_9","accessory_backpack_a"),
  ("accessory_bagsbottles_random_10","accessory_backpack_b"),
  ...
  ("accessory_bagsbottles_random2_4","accessory_backpack_a"),
  ("accessory_bagsbottles_random2_5","accessory_backpack_b"),
  ("accessory_bagsbottles_random2_end", "accessory_bagsbottles_random2_end"),

  ("accessory_spear_0", "acc_stand_spear_1"),
  ("accessory_spear_1", "acc_stand_spear_2"),
  ("accessory_spear_2", "acc_stand_spear_3"),
  ("accessory_spear_end", "acc_stand_spear_3"),

  ("accessory_shield_0", "acc_stand_shield_1"),
  ("accessory_shield_1", "acc_stand_shield_2"),
  ("accessory_shield_2", "acc_stand_shield_3"),
  ("accessory_shield_3", "acc_stand_shield_4"),
  ("accessory_shield_end", "acc_stand_spear_3"),

  ("horse_material_1", "caballo1"),
  ("horse_material_2", "caballo2"),
  ("horse_material_3", "caballo3"),
  ("horse_material_4", "caballo4"),
  ("horse_material_5", "caballo5"),
  ("horse_material_6", "caballo6"),
  ("horse_material_end", "caballo1"),

  ("demak_shield_var_begin", "demak_shield_a"),
  ("demak_shield_var_1", "demak_shield_a_1"),
  ("demak_shield_var_2", "demak_shield_a_2"),
  ("demak_shield_var_3", "demak_shield_a_3"),
  ("demak_shield_var_4", "demak_shield_a_4"),
  ("demak_shield_var_end", "demak_shield_a_4"),

  ("demak_shield2_var_begin", "demak_shield_b"),
  ("demak_shield2_var_1", "demak_shield_b_1"),
  ("demak_shield2_var_2", "demak_shield_b_2"),
  ("demak_shield2_var_3", "demak_shield_b_3"),
  ("demak_shield2_var_end", "demak_shield_b_3"),
