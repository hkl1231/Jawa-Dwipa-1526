...
#  ("black_khergit_raiders","Black Khergit Raiders",icon_khergit_horseman_b|carries_goods(2),0,fac_black_khergits,bandit_personality,[(trp_black_khergit_guard,1,10),(trp_black_khergit_horseman,5,5)]),
  ...
  ("sea_raiders","Pirates",icon_ship|pf_is_ship|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_sea_raider,4,20)]),
...
# Reinforcements
  ...
  ("kingdom_3_reinforcements_a", "{!}kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_banten_recruit,3,5),(trp_banten_veteran,4,9)]), 
  ("kingdom_3_reinforcements_b", "{!}kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_banten_infantry,2,4),(trp_banten_archer,2,4),(trp_banten_marksman,1,2)]),
  ("kingdom_3_reinforcements_c", "{!}kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_banten_horseman,2,4),(trp_banten_knight,2,3)]), #Khergits are a bit less-powered thats why they have a bit more troops in their modernised party template (4-7, others 3-5)
  ...
  ("kingdom_7_reinforcements_a", "{!}kingdom_7_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_7_reinforcements_b", "{!}kingdom_7_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_7_reinforcements_c", "{!}kingdom_7_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_8_reinforcements_a", "{!}kingdom_8_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_8_reinforcements_b", "{!}kingdom_8_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_8_reinforcements_c", "{!}kingdom_8_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_9_reinforcements_a", "{!}kingdom_9_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_9_reinforcements_b", "{!}kingdom_9_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_9_reinforcements_c", "{!}kingdom_9_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_10_reinforcements_a", "{!}kingdom_10_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_10_reinforcements_b", "{!}kingdom_10_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_10_reinforcements_c", "{!}kingdom_10_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_11_reinforcements_a", "{!}kingdom_11_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_11_reinforcements_b", "{!}kingdom_11_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_11_reinforcements_c", "{!}kingdom_11_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_12_reinforcements_a", "{!}kingdom_12_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_majapahit_recruit,5,10),(trp_majapahit_footman,2,4)]),
  ("kingdom_12_reinforcements_b", "{!}kingdom_12_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_majapahit_skirmisher,2,4),(trp_majapahit_infantry,2,3),(trp_majapahit_guard,1,3)]),
  ("kingdom_12_reinforcements_c", "{!}kingdom_12_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_majapahit_horseman,3,5)]),

  ("kingdom_13_reinforcements_a", "{!}kingdom_13_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_madura_recruit,2,5),(trp_madura_footman,2,4)]),
  ("kingdom_13_reinforcements_b", "{!}kingdom_13_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_madura_skirmisher,2,4),(trp_madura_infantry,2,3),(trp_madura_guard,1,3)]),
  ("kingdom_13_reinforcements_c", "{!}kingdom_13_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_madura_horseman,1,3)]),

  ("portugal_reinforcements_a","{!}portugal_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_portugal_militia,2,4),(trp_portugal_infantry,2,5),(trp_portugal_spearman,5,10)]),
  ("portugal_reinforcements_b","{!}portugal_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_portugal_pikeman,1,4),(trp_portugal_crossbowman,2,8),(trp_portugal_arquebusier,2,4)]),
  ("portugal_reinforcements_c","{!}portugal_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_portugal_knight,1,4),(trp_portugal_cavalry,1,4)]),
