...
game_menus = [
  ...
  "none",
    ...
    [
     ...
     ("continue_story",[],"Story Mode.",
       [
          (jump_to_menu, "mnu_start_game_story"),
        ]
       ),
      ("go_back",[],"Go back",
       [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    "In 1529 AD, Java Island is a land of turmoil and ambition. The once-mighty Majapahit Empire is collapsing, its golden age a fading memory.\
 Rising from its ashes, the sultanate of Demak, driven by Islamic fervor, seeks to unify Java under its banner.\
 Amid this chaos, the coastal cities of Cirebon and Banten emerge as powerful contenders.\
 Cirebon, with its strategic diplomacy, and Banten, with its military might, challenge the old order, threatening the stability of the Sundanese kingdom of Pajajaran.\
 Java's lush landscapes and bustling ports become the stage for high-stakes drama. Alliances form and break in an instant, and every decision can mean survival or doom.\
 Will you restore Majapahit, rally under Demak, or champion Cirebon and Banten? The destiny of Java is in your hands, you...",
    "none",
    [
...
#SB : skip merchant quest
      ...
      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"Go to Dayeuh Pakuan, in the Heart of Pasundan.",
       [
...
#         (change_screen_return),
      ...
      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"Take a caravel to Kalapa, in the richest port city.",
       [
...
#         (change_screen_return),
      ...
      ("town_3",[(eq, "$current_startup_quest_phase", 0),],"Join a santri caravan to Bintara, in the capital of Demak Sultanate.",
       [
         (assign, "$current_town", "p_town_15"),
         (assign, "$g_starting_town", "$current_town"),
...
#         (change_screen_return),
      ...
      ("town_4",[(eq, "$current_startup_quest_phase", 0),],"Take a pilgrimage to Mataram, in the capital of Mataram.",
       [
         (assign, "$current_town", "p_town_14"),
         (assign, "$g_starting_town", "$current_town"),
...
#         (change_screen_return),
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),],"Take a ship to Cirebon, in the capital city of Cirebon Sultanate.",
       [
...
#         (change_screen_return),
      ...
      ("town_6",[(eq, "$current_startup_quest_phase", 0),],"Take a pilgrimage to Budur, in the heart of Kedu Plains.",
       [
...
##       ),
  ...
  (
    ...
    [
      ("scene_edit",[],"Scene Editor.",
       [
		 (jump_to_menu, "mnu_test_scene"),
       ]),
      ("scene_edit_story_mode",[],"Scene Editor.",
       [
		 (jump_to_menu, "mnu_scene_edit_story"),
       ]),
      ...
      [
        ...
        (troop_add_item, "$g_player_troop","itm_hairband_universal_jawa_a",0),
        (troop_add_item, "$g_player_troop","itm_bhayangkara_medium_a",0),
        (troop_add_item, "$g_player_troop","itm_feet",0),
  ...
  ("reports",mnf_enable_hot_keys,
   ...
   [(call_script, "script_game_get_party_companion_limit"),
    ...
    [
      ...
      ("view_world_map",[],"View the world map.",
      [
...
#         (assign,"$character_gender", tf_male),
         (jump_to_menu,"mnu_start_game_1_2"),
        ]
       ),
      ("start_female",[],"Female",
       [
...
##diplomacy end+
  ...
  ("start_game_1_2",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
      ...
      ("start_sunda",[],"Sunda",
       [
         (troop_set_type,"trp_player", 0),
         (assign,"$character_gender", tf_sunda),
         (jump_to_menu,"mnu_start_character_1"),
        ]
       ),
      ("start_portugal",[],"Portuguese",
       [
         (troop_set_type,"trp_player", 3),
         (assign,"$character_gender", tf_portugal),
         (jump_to_menu,"mnu_start_character_1"),
        ]
       ),
      ("start_chinese",[],"Chinese",
       [
         (troop_set_type,"trp_player", 4),
         (assign,"$character_gender", tf_chinese),
         (jump_to_menu,"mnu_start_character_1"),
        ]
       ),
      ("start_arab",[],"Arabs",
       [
         ...
         (assign,"$character_gender", tf_arab),
         (jump_to_menu,"mnu_start_character_1"),
        ]
       ),

#      ("start_bugis",[],"TODO Bugis",
#       [
#         (troop_set_type,"trp_player", 0),
#         (assign,"$character_gender", tf_male),
#         (jump_to_menu,"mnu_start_character_1"),
...
#        ]
#       ),
#      ("start_melanesia",[],"TODO Melanesian",
#       [
#         (troop_set_type,"trp_player", 0),
#         (assign,"$character_gender", tf_male),
#         (jump_to_menu,"mnu_start_character_1"),
...
#       ),
  ...
  (
    ...
    [],
    [
      ("page",[(this_or_next|eq,"$character_gender",tf_male),(eq,"$character_gender",tf_sunda)
          ],"A page at a keraton's court.",[
            (assign,"$background_answer_2", cb2_page),
            (str_store_string,s11,"str_story_childhood_page"),
            (jump_to_menu,"mnu_start_character_3"),
        ]),
      ("page",[(this_or_next|eq,"$character_gender",tf_portugal),(this_or_next|eq,"$character_gender",tf_arab),(eq,"$character_gender",tf_chinese)
          ],"A page at court's hall.",[
            (assign,"$background_answer_2", cb2_page),
            (str_store_string,s11,"str_story_childhood_page"),
            (jump_to_menu,"mnu_start_character_3"),
        ]),
  ...
  (
	...
	(jump_to_menu,"mnu_start_character_4"),
      ...
      ("lady",[(eq,"$character_gender",tf_female)],"A consort of a local lords.",[
  ...
  (
    ...
    [
      ...
      (try_begin),
        ...
        (troop_add_item, "trp_player","itm_steel_shield_a",imod_battered),
      ...
      (else_try),
        ...
        (troop_add_item, "trp_player","itm_sunda_shield_leather_a",imod_battered),

        (troop_add_gold, "trp_player", 100),
      (else_try),
        (eq,"$background_type",cb_noble),
        (eq,"$character_gender",tf_chinese),
        (troop_raise_attribute, "trp_player",ca_intelligence,1),
        (troop_raise_attribute, "trp_player",ca_charisma,2),
        (troop_raise_skill, "trp_player",skl_weapon_master,1),
        (troop_raise_skill, "trp_player",skl_power_strike,1),
        ...
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,10),
        (troop_raise_proficiency, "trp_player",wpt_polearm,10),
        (troop_add_item, "trp_player","itm_china_merc_cav_helmet_1"),
        (troop_add_item, "trp_player","itm_china_merc_heavy_cav_1"),
        (troop_add_item, "trp_player","itm_china_merc_boots"),
        (troop_add_item, "trp_player","itm_china_sword"),
        (troop_add_item, "trp_player","itm_china_spear_1"),
        (troop_set_slot, "trp_player", slot_troop_renown, 100),
        (call_script, "script_change_player_honor", 3),
        (troop_add_gold, "trp_player", 400),
      (else_try),
        (eq,"$background_type",cb_noble),
        (eq,"$character_gender",tf_portugal),
        (troop_raise_attribute, "trp_player",ca_intelligence,1),
        (troop_raise_attribute, "trp_player",ca_charisma,2),
        (troop_raise_skill, "trp_player",skl_weapon_master,1),
        (troop_raise_skill, "trp_player",skl_power_strike,1),
        ...
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,10),
        (troop_raise_proficiency, "trp_player",wpt_polearm,10),
        (troop_add_item, "trp_player","itm_portuguese_hat_b"),
        (troop_add_item, "trp_player","itm_portuguese_doublet_rich"),
        (troop_add_item, "trp_player","itm_leather_boots"),
        (troop_add_item, "trp_player","itm_portuguese_fidalgo_sword_c"),
        (troop_add_item, "trp_player","itm_portuguese_stiletto_a"),
        (troop_set_slot, "trp_player", slot_troop_renown, 100),
        (call_script, "script_change_player_honor", 3),
        (troop_add_gold, "trp_player", 600),
      (else_try),
        (eq,"$background_type",cb_noble),
        (eq,"$character_gender",tf_arab),
        (troop_raise_attribute, "trp_player",ca_intelligence,1),
        (troop_raise_attribute, "trp_player",ca_charisma,2),
        (troop_raise_skill, "trp_player",skl_weapon_master,1),
        (troop_raise_skill, "trp_player",skl_power_strike,1),
        ...
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,10),
        (troop_raise_proficiency, "trp_player",wpt_polearm,10),
        (troop_add_item, "trp_player","itm_arab_turkish_hat_1"),
        (troop_add_item, "trp_player","itm_arabic_merchant_robe_a"),
        (troop_add_item, "trp_player","itm_khergit_leather_boots"),
        (troop_add_item, "trp_player","itm_scimitar_b"),
        (troop_add_item, "trp_player","itm_steel_shield_a"),
        (troop_set_slot, "trp_player", slot_troop_renown, 100),
        (call_script, "script_change_player_honor", 3),
     ...
     (else_try), #SB : re-enable priests
       ...
       (troop_raise_proficiency, "trp_player", wpt_one_handed_weapon, 10),
       (troop_add_item, "trp_player","itm_sunda_shield_leather_a",0),
	...
	(try_begin), #SB :re-enable 3x cb3 options, adding 1x body armor and weapon + food
       ...
       (troop_add_gold, "trp_player", 10),
       (store_random_in_range, ":shield_item", "itm_sunda_shield_a", "itm_sunda_shield_leather_d"),
       (troop_add_item, "trp_player",":shield_item",imod_heavy),
       (store_random_in_range, ":armor_item", "itm_sunda_warrior_a", "itm_demak_spearman_1"),
       (store_random_in_range, ":armor_imod", imod_tattered, imod_reinforced),
       (troop_add_item, "trp_player",":armor_item",":armor_imod"),
       (troop_add_item, "trp_player", "itm_feet", 0),
       #store a random sword
       (store_random_in_range, ":weapon_item", "itm_parang_jawa_1", "itm_parang_jawa_6"),
       (try_begin), #2+4 offset for scimitar + sarranid swords
         (lt, ":weapon_item", "itm_parang_jawa_1"),
         (val_sub, ":weapon_item", "itm_spear_jawa_1"),
         (val_add, ":weapon_item", "itm_keris_jawa_1"),
       (try_end),
   ...
   (else_try),
       ...
       (store_random_in_range, ":helmet_item", "itm_viet_hat_1", "itm_viet_tunic_a"),
       (store_random_in_range, ":weapon_item", "itm_viet_katana_1", "itm_spear_flag_jawa_1"),
       (store_random_in_range, ":armor_item", "itm_viet_tunic_a", "itm_wisby_gauntlets_black"),
       (store_random_in_range, ":boots_item", "itm_splinted_greaves_nospurs", "itm_viet_katana_1"),
       ...
       (try_begin),
         ...
         (store_random_in_range, ":helmet_item", "itm_hat_sunda_a", "itm_helmet_sunda_a"),
         (store_random_in_range, ":weapon_item", "itm_sunda_bedog_a", "itm_keris_jawa_1"),
       (else_try),
...
#         (assign, ":helmet_imod", imod_crude),
       (else_try),
         ...
         (store_random_in_range, ":helmet_item", "itm_hat_sunda_a", "itm_helmet_sunda_a"),
         (store_random_in_range, ":weapon_item", "itm_sunda_bedog_a", "itm_spear_bamboo_a"),
       (else_try),
       ...
       (try_begin),
         ...
         (else_try), #use a low-requirement gambeson
           (store_random_in_range, ":armor_item", "itm_sunda_spearman_a", "itm_sunda_veteran_warrior_a"),
           (troop_add_item, "trp_player", ":armor_item", ":armor_imod"),
         (try_end),
       (try_end),
       (try_begin),
   ...
   (else_try),
        ...
        (troop_add_item, "trp_player","itm_parang_jawa_1",imod_chipped),
        (troop_add_item, "trp_player","itm_demak_tunic_1",0),
        (troop_add_item, "trp_player","itm_kedu_feet_a",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_feet",0),
        (troop_add_item, "trp_player","itm_demak_tunic_3",0),

        (troop_add_item, "trp_player","itm_keris_jawa_1", imod_balanced),
...
#        (troop_add_item, "trp_player","itm_bolts",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_demak_militia_1",0),
        (troop_add_item, "trp_player","itm_feet",0),
        (troop_add_item, "trp_player","itm_hat_demak_a",0),
        (troop_add_item, "trp_player","itm_staff",0),
#        (troop_add_item, "trp_player","itm_hunting_crossbow",0),
#        (troop_add_item, "trp_player","itm_bolts",0),
        (troop_add_item, "trp_player","itm_saddle_horse",0),
...
#       (troop_add_item, "trp_player","itm_leather_gloves",imod_ragged),
       ...
       (troop_add_item, "trp_player", "itm_shirt"),
#       (troop_add_item, "trp_player", "itm_pilgrim_hood"),
       (troop_add_item, "trp_player", "itm_feet"),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_demak_recruit_a",imod_sturdy),
        (troop_add_item, "trp_player","itm_feet",imod_ragged),
        (troop_add_item, "trp_player","itm_keris_jawa_1", imod_rusty),
#        (troop_add_item, "trp_player","itm_hunting_crossbow", 0),
#        (troop_add_item, "trp_player","itm_bolts", 0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_bhayangkara_heavy_a",imod_ragged),
        (troop_add_item, "trp_player","itm_kedu_feet_b",imod_tattered),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_keris_jawa_1", 0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_kedu_infantry_a",imod_sturdy),
        (troop_add_item, "trp_player","itm_feet",0),
        (troop_add_item, "trp_player","itm_keris_jawa_1", imod_rusty),
        (troop_add_item, "trp_player","itm_saddle_horse",imod_swaybacked),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
...
#      (set_show_messages, 1),
  ...
  (
    "choose_banner",mnf_disable_all_keys,
    "Select your banner type.",
    "none",
    [],
    [
      ("banner_select",[],"Select from Preset",[
      (try_begin),
        (jump_to_menu, "mnu_auto_return"),
        (start_presentation, "prsnt_banner_selection"),
      (else_try),
      ...
      ("banner_custom",[],"Customize Banner",[
        (assign, "$assigned_troop", "trp_player"), # DUNDE 
        (jump_to_menu, "mnu_auto_return"),
        (start_presentation, "prsnt_custom_banner"),
      (else_try),
        (change_screen_return, 0),
  ...
  ("camp_action",0,
   ...
   [
    ...
    [
      ...
      ##diplomacy end+
      ("action_modify_banner",[],"Modify your banner.", [(jump_to_menu, "mnu_camp_modify_banner"),]),
  ...
  (
    ...
    [
	 ...
	 (try_begin),
		...
		(assign, "$player_has_bodyslided", 0),
	 (try_end),
	## WINDYPLAINS- ##
     (try_begin),
       (eq, "$g_battle_result", 1),
...
#####TREASURE HUNT!######
  (
    "treasure_hunt_1",0,
    "You arrived at an abandoned temple.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_abandoned_temple"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  ...
  (
    "treasure_hunt_2",0,
    "You arrived at Candi Arjuna.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  ...
  (
    "treasure_hunt_3",0,
    "You arrived at an Candi Sambisari.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
  ...
  (
    "treasure_hunt_6",0,
    "You stumbled upon an unknown structure.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
  ...
  (
    "treasure_hunt_7",0,
    "You arrived at Lawang Swarga.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_gerbang_swarga"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  ...
  (
    "treasure_hunt_9",0,
    "You arrived at Sumur Pancaswara.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
  ...
  (
    "treasure_hunt_10",0,
    "You arrived at a place believed to be the Palace of Rara Kidul.",
    "none",
    [],
    [
      ("enter",[],"Investigate.",[(set_jump_mission,"mt_town_center"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
  ...
  (
    ...
    [],
    [
     ("story_1",[],"Beyond the Cape.",
       [
          (jump_to_menu, "mnu_portugal_story_scenes"),
        ]
       ),
     ("story_2",[],"Old Friend from the South.",
       [
          (jump_to_menu, "mnu_china_story_scenes"),
        ]
       ),
     ("story_3",[],"The Source of Spices.",
       [
          (jump_to_menu, "mnu_arab_story_scenes"),
        ]
       ),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_quit)]),
    ]
  ),

  (
    "portugal_story_scenes",0,
    "Portugal.",
    "none",
    [],
    [

      ("enter",[],"Scene Portugal.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_1_1"],[change_screen_mission]]),
      ("enter",[],"Scene Sea Battle.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_1_2"],[change_screen_mission]]),
      ("enter",[],"Scene Cape of Good Hope.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_1_3"],[change_screen_mission]]),
      ("enter",[],"Scene Malacca.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_1_4"],[change_screen_mission]]),
      ("enter",[],"Scene Kalapa.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_1_5"],[change_screen_mission]]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_quit)]),
    ]
  ),

  (
    "china_story_scenes",0,
    "China.",
    "none",
    [],
    [

      ("enter",[],"Scene Fujian.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_2_1"],[change_screen_mission]]),
      ("enter",[],"Scene Guangzhou.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_2_2"],[change_screen_mission]]),
      #Use Portugal's malaca Scene
#      ("enter",[],"Scene Malaca.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_walls"],[change_screen_mission]]),
      #Use Town Scene
#      ("enter",[],"Scene Kalapa.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_castle"],[change_screen_mission]]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_quit)]),
    ]
  ),
  ...
  (
    ...
    [
      ...
      ("enter",[],"Scene Baghdad.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_3_1"],[change_screen_mission]]),
      ("enter",[],"Scene India.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_3_2"],[change_screen_mission]]),
      ("enter",[],"Scene Sea Battle.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_story_3_3"],[change_screen_mission]]),
      #Use Portugal's malaca Scene
#      ("enter",[],"Scene Malaca.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_walls"],[change_screen_mission]]),
      #Use Town Scene
#      ("enter",[],"Scene Kalapa.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_castle"],[change_screen_mission]]),
  ...
  (
    ...
    [
      ...
      ("enter",[],"Enter TEMP.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_jawa_temp_town_center"],[change_screen_mission]]),
      ("enter",[],"Enter Town 1 Center.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_center"],[change_screen_mission]]),
      ("enter",[],"Enter Town 1 Wall.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_walls"],[change_screen_mission]]),
      ("enter",[],"Enter Town 2 Center.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_2_center"],[change_screen_mission]]),
      ("enter",[],"Enter jawa center.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_jawa_universal_town_center"],[change_screen_mission]]),
      ("enter",[],"Enter jawa wall.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_jawa_universal_town_wall"],[change_screen_mission]]),
      ("enter",[],"Enter sunda center.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_sunda_universal_town_center"],[change_screen_mission]]),
      ("enter",[],"Enter sunda wall.",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_sunda_universal_town_wall"],[change_screen_mission]]),
      ("enter_f1",[],"{!}Scene 1",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_scene_trailer_march_1"],[change_screen_mission]]),
      ("enter_f2",[],"Village",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_village_1"],[change_screen_mission]]),
      ("enter_f3",[],"tavern",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_tavern"],[change_screen_mission]]),
      ("enter_f4",[],"Arena",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_1_arena"],[change_screen_mission]]),
      ("enter_f4",[],"Castle",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_15_castle"],[change_screen_mission]]),
      ("enter",[],"{!}Demak Center",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_15_center"],[change_screen_mission]]),
      ("enter",[],"{!}Demak Wall",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_town_15_walls"],[change_screen_mission]]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_quit)]),
    ]
  ),
  (
    ...
    [
      ...
      ("enter_f1",[],"{!}Scene 1",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_scene_trailer_march_1"],[change_screen_mission]]),
      ("enter_f2",[],"{!}Scene 2",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_scene_trailer_march_2"],[change_screen_mission]]),
      ("enter_f3",[],"{!}Scene 3",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_scene_trailer_march_3"],[change_screen_mission]]),
      ("enter_f4",[],"{!}Scene 4",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_scene_trailer_march_4"],[change_screen_mission]]),
...
#		(str_store_faction_name, s9, "$players_kingdom"),
  ...
  (
    "notification_sumedang_larang",0,
    "Pakuan has been destroyed, Prabu Siliwangi has been anounced that continous war could damage the realm, so he decided to moksa, gone never to return. He passed the crown of Binokasih to his patih Geusan Ulun.\
     As the result, Kingdom of Sumedang Larang was formed as the successor of Pajajaran.",
    "none",
    [],
    [
      ("continue",[],"Continue...",
...
#SB : secondary cheat menu
 ...
 AI Behaviour is {s13}{reg18? (currently {s14}):}, Object is {s15}{reg19? (currently {s16}):} at ({reg20},{reg21})",
  ...
  ("start_game_story",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "COMING SOON!.",
    "none",
    [],
    [
